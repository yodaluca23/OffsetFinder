...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a525ab0,
        .kernelcache__gPhysBase = 0xfffffff0079302a8,
        .kernelcache__gPhysSize = 0xfffffff0079302a8 + 8,
        .kernelcache__gVirtBase = 0xfffffff00792e460,
        .kernelcache__perfmon_devices = 0xfffffff00a565550,
        .kernelcache__perfmon_dev_open = 0xfffffff007f3108c,
        .kernelcache__ptov_table = 0xfffffff0078e39c8,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a564910,
        .kernelcache__vm_pages = 0xfffffff0078e0108,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0078e2968,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a564908,
        .kernelcache__vn_kqfilter = 0xfffffff007f7fbe0,
    },
};
