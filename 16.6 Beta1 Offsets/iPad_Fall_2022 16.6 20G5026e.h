...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a549ab0,
        .kernelcache__gPhysBase = 0xfffffff0079382a8,
        .kernelcache__gPhysSize = 0xfffffff0079382a8 + 8,
        .kernelcache__gVirtBase = 0xfffffff007936460,
        .kernelcache__perfmon_devices = 0xfffffff00a589550,
        .kernelcache__perfmon_dev_open = 0xfffffff007f3508c,
        .kernelcache__ptov_table = 0xfffffff0078eb9c8,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a588910,
        .kernelcache__vm_pages = 0xfffffff0078e8108,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0078ea968,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a588908,
        .kernelcache__vn_kqfilter = 0xfffffff007f83be0,
    },
};
