...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a23dab0,
        .kernelcache__gPhysBase = 0xfffffff0078dc288,
        .kernelcache__gPhysSize = 0xfffffff0078dc288 + 8,
        .kernelcache__gVirtBase = 0xfffffff0078da440,
        .kernelcache__perfmon_devices = 0xfffffff00a27d530,
        .kernelcache__perfmon_dev_open = 0xfffffff007e7e434,
        .kernelcache__ptov_table = 0xfffffff00788f9a0,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a27c910,
        .kernelcache__vm_pages = 0xfffffff00788c0f8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff00788e950,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a27c908,
        .kernelcache__vn_kqfilter = 0xfffffff007eccc44,
    },
};
