...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a451ab0,
        .kernelcache__gPhysBase = 0xfffffff0079441b8,
        .kernelcache__gPhysSize = 0xfffffff0079441b8 + 8,
        .kernelcache__gVirtBase = 0xfffffff007942370,
        .kernelcache__perfmon_devices = 0xfffffff00a491520,
        .kernelcache__perfmon_dev_open = 0xfffffff007f03d78,
        .kernelcache__ptov_table = 0xfffffff0078f79b8,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a490910,
        .kernelcache__vm_pages = 0xfffffff0078f4100,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0078f6958,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a490908,
        .kernelcache__vn_kqfilter = 0xfffffff007f52588,
    },
};
