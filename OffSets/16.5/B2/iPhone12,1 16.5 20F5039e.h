...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__gPhysBase = 0xfffffff007964168,
        .kernelcache__gPhysSize = 0xfffffff007964168 + 8,
        .kernelcache__gVirtBase = 0xfffffff007962340,
        .kernelcache__perfmon_devices = 0xfffffff00a4f7720,
        .kernelcache__perfmon_dev_open = 0xfffffff007f1ca30,
        ...
        .kernelcache__vn_kqfilter = 0xfffffff007f6b948,
    },
};
