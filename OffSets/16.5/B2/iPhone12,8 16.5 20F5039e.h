...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.5.0: Thu Apr  6 00:09:42 PDT 2023; root:xnu-8796.120.31.502.2~1/RELEASE_ARM64_T8030",
        ...
        .kernelcache__cdevsw = 0xfffffff00a471a30,
        .kernelcache__gPhysBase = 0xfffffff007954168,
        .kernelcache__gPhysSize = 0xfffffff007954168 + 8,
        .kernelcache__gVirtBase = 0xfffffff007952340,
        .kernelcache__perfmon_devices = 0xfffffff00a4af720,
        .kernelcache__perfmon_dev_open = 0xfffffff007f08a30,
        .kernelcache__ptov_table = 0xfffffff007907278,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a4aeb10,
        .kernelcache__vm_pages = 0xfffffff007903fb0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff007906218,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a4aeb08,
        .kernelcache__vn_kqfilter = 0xfffffff007f57948,
    },
};
