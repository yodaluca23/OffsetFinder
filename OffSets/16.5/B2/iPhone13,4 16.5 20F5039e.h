...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.5.0: Thu Apr  6 00:10:02 PDT 2023; root:xnu-8796.120.31.502.2~1/RELEASE_ARM64_T8101",
        ...
        .kernelcache__cdevsw = 0xfffffff00a53da30,
        .kernelcache__gPhysBase = 0xfffffff007944258,
        .kernelcache__gPhysSize = 0xfffffff007944258 + 8,
        .kernelcache__gVirtBase = 0xfffffff007942430,
        .kernelcache__perfmon_devices = 0xfffffff00a57b750,
        .kernelcache__perfmon_dev_open = 0xfffffff007f15d08,
        .kernelcache__ptov_table = 0xfffffff0078f7288,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a57ab10,
        .kernelcache__vm_pages = 0xfffffff0078f3fb8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0078f6228,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a57ab08,
        .kernelcache__vn_kqfilter = 0xfffffff007f64f58,
    },
};
