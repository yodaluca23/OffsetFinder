...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.5.0: Thu Apr  6 00:08:52 PDT 2023; root:xnu-8796.120.31.502.2~1/RELEASE_ARM64_T8110",
        ...
        .kernelcache__cdevsw = 0xfffffff00a571a30,
        .kernelcache__gPhysBase = 0xfffffff007960258,
        .kernelcache__gPhysSize = 0xfffffff007960258 + 8,
        .kernelcache__gVirtBase = 0xfffffff00795e430,
        .kernelcache__perfmon_devices = 0xfffffff00a5af750,
        .kernelcache__perfmon_dev_open = 0xfffffff007f367e0,
        .kernelcache__ptov_table = 0xfffffff007913280,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a5aeb10,
        .kernelcache__vm_pages = 0xfffffff00790ffc0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff007912230,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a5aeb08,
        .kernelcache__vn_kqfilter = 0xfffffff007f833ec,
    },
};
