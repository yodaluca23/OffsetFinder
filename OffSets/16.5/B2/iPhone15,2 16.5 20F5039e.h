...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.5.0: Thu Apr  6 00:09:44 PDT 2023; root:xnu-8796.120.31.502.2~1/RELEASE_ARM64_T8120",
        ...
        .kernelcache__cdevsw = 0xfffffff00a4bda30,
        ...
        .kernelcache__perfmon_devices = 0xfffffff00a4fb730,
        .kernelcache__perfmon_dev_open = 0xfffffff007f122d0,
        .kernelcache__ptov_table = 0xfffffff0078ff278,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a4fab10,
        .kernelcache__vm_pages = 0xfffffff0078fbfb8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0078fe228,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a4fab08,
        .kernelcache__vn_kqfilter = 0xfffffff007f5eedc,
    },
};
