...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__gPhysBase = 0xfffffff007914238,
        .kernelcache__gPhysSize = 0xfffffff007914238 + 8,
        .kernelcache__gVirtBase = 0xfffffff007912410,
        .kernelcache__perfmon_devices = 0xfffffff00a41b730,
        .kernelcache__perfmon_dev_open = 0xfffffff007ec30f0,
        ...
        .kernelcache__vn_kqfilter = 0xfffffff007f12008,
    },
};
