...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a511a30,
        .kernelcache__gPhysBase = 0xfffffff007950258,
        .kernelcache__gPhysSize = 0xfffffff007950258 + 8,
        .kernelcache__gVirtBase = 0xfffffff00794e430,
        .kernelcache__perfmon_devices = 0xfffffff00a54f750,
        .kernelcache__perfmon_dev_open = 0xfffffff007f1e7e0,
        .kernelcache__ptov_table = 0xfffffff007903280,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a54eb10,
        .kernelcache__vm_pages = 0xfffffff0078fffc0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff007902230,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a54eb08,
        .kernelcache__vn_kqfilter = 0xfffffff007f6b3ec,
    },
};
