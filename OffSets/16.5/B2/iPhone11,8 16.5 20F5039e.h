...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.5.0: Thu Apr  6 00:10:13 PDT 2023; root:xnu-8796.120.31.502.2~1/RELEASE_ARM64_T8020",
        ...
        .kernelcache__cdevsw = 0xfffffff00a241a30,
        .kernelcache__gPhysBase = 0xfffffff0078ec238,
        .kernelcache__gPhysSize = 0xfffffff0078ec238 + 8,
        .kernelcache__gVirtBase = 0xfffffff0078ea410,
        .kernelcache__perfmon_devices = 0xfffffff00a27f730,
        .kernelcache__perfmon_dev_open = 0xfffffff007e7b0f0,
        .kernelcache__ptov_table = 0xfffffff00789f260,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a27eb10,
        .kernelcache__vm_pages = 0xfffffff00789bfa8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff00789e210,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a27eb08,
        .kernelcache__vn_kqfilter = 0xfffffff007eca008,
    },
};
