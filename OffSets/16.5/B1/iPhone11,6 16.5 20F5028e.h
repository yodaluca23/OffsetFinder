...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.5.0: Fri Mar 17 16:31:50 PDT 2023; root:xnu-8796.120.16~14/RELEASE_ARM64_T8020",
        ...
        .kernelcache__cdevsw = 0xfffffff00a3e1a30,
        .kernelcache__gPhysBase = 0xfffffff007918198,
        .kernelcache__gPhysSize = 0xfffffff007918198 + 8,
        .kernelcache__gVirtBase = 0xfffffff007916370,
        .kernelcache__perfmon_devices = 0xfffffff00a41f730,
        .kernelcache__perfmon_dev_open = 0xfffffff007ec70ec,
        .kernelcache__ptov_table = 0xfffffff0078cb260,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a41eb10,
        .kernelcache__vm_pages = 0xfffffff0078c7fa8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0078ca210,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a41eb08,
        .kernelcache__vn_kqfilter = 0xfffffff007f16004,
    },
};
