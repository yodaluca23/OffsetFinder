...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.5.0: Fri Mar 17 16:32:22 PDT 2023; root:xnu-8796.120.16~14/RELEASE_ARM64_T8110",
        ...
        .kernelcache__cdevsw = 0xfffffff00a56da30,
        .kernelcache__gPhysBase = 0xfffffff00795c1b8,
        .kernelcache__gPhysSize = 0xfffffff00795c1b8 + 8,
        .kernelcache__gVirtBase = 0xfffffff00795a390,
        .kernelcache__perfmon_devices = 0xfffffff00a5ab750,
        .kernelcache__perfmon_dev_open = 0xfffffff007f327a8,
        .kernelcache__ptov_table = 0xfffffff00790f280,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a5aab10,
        .kernelcache__vm_pages = 0xfffffff00790bfc0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff00790e230,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a5aab08,
        .kernelcache__vn_kqfilter = 0xfffffff007f7f3b4,
    },
};
