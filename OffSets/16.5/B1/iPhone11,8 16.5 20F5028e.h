...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a245a30,
        .kernelcache__gPhysBase = 0xfffffff0078f0198,
        .kernelcache__gPhysSize = 0xfffffff0078f0198 + 8,
        .kernelcache__gVirtBase = 0xfffffff0078ee370,
        .kernelcache__perfmon_devices = 0xfffffff00a283730,
        .kernelcache__perfmon_dev_open = 0xfffffff007e7f0ec,
        .kernelcache__ptov_table = 0xfffffff0078a3260,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a282b10,
        .kernelcache__vm_pages = 0xfffffff00789ffa8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0078a2210,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a282b08,
        .kernelcache__vn_kqfilter = 0xfffffff007ece004,
    },
};
