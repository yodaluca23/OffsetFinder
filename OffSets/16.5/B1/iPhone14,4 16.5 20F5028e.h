...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a50da30,
        .kernelcache__gPhysBase = 0xfffffff0079501b8,
        .kernelcache__gPhysSize = 0xfffffff0079501b8 + 8,
        .kernelcache__gVirtBase = 0xfffffff00794e390,
        .kernelcache__perfmon_devices = 0xfffffff00a54b750,
        .kernelcache__perfmon_dev_open = 0xfffffff007f1e7a8,
        .kernelcache__ptov_table = 0xfffffff007903280,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a54ab10,
        .kernelcache__vm_pages = 0xfffffff0078fffc0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff007902230,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a54ab08,
        .kernelcache__vn_kqfilter = 0xfffffff007f6b3b4,
    },
};
