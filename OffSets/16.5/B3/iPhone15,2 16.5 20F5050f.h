...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.5.0: Sun Apr 16 16:46:04 PDT 2023; root:xnu-8796.120.47.0.1~37/RELEASE_ARM64_T8120",
        ...
        .kernelcache__cdevsw = 0xfffffff00a4c5a30,
        .kernelcache__gPhysBase = 0xfffffff00794c1b8,
        .kernelcache__gPhysSize = 0xfffffff00794c1b8 + 8,
        .kernelcache__gVirtBase = 0xfffffff00794a390,
        .kernelcache__perfmon_devices = 0xfffffff00a503730,
        .kernelcache__perfmon_dev_open = 0xfffffff007f12320,
        .kernelcache__ptov_table = 0xfffffff0078ff278,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a502b10,
        .kernelcache__vm_pages = 0xfffffff0078fbfb8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0078fe228,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a502b08,
        .kernelcache__vn_kqfilter = 0xfffffff007f5ef2c,
    },
};
