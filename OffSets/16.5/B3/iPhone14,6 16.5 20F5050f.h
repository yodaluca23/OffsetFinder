...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__gVirtBase = 0xfffffff00795e480,
        .kernelcache__perfmon_devices = 0xfffffff00a5b7750,
        .kernelcache__perfmon_dev_open = 0xfffffff007f367e0,
        .kernelcache__ptov_table = 0xfffffff007913280,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a5b6b10,
        .kernelcache__vm_pages = 0xfffffff00790ffc0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff007912230,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a5b6b08,
