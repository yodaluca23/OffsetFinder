...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.5.0: Sun Apr 16 16:48:08 PDT 2023; root:xnu-8796.120.47.0.1~37/RELEASE_ARM64_T8020",
        ...
        .kernelcache__gPhysBase = 0xfffffff0078f0288,
        .kernelcache__gPhysSize = 0xfffffff0078f0288 + 8,
        .kernelcache__gVirtBase = 0xfffffff0078ee460,
        .kernelcache__perfmon_devices = 0xfffffff00a287730,
        .kernelcache__perfmon_dev_open = 0xfffffff007e7f0f0,
        .kernelcache__ptov_table = 0xfffffff0078a3260,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a286b10,
        .kernelcache__vm_pages = 0xfffffff00789ffa8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0078a2210,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a286b08,
        .kernelcache__vn_kqfilter = 0xfffffff007ece008,
    },
};
