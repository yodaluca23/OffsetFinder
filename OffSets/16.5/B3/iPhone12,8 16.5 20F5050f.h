...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a475ab0,
        .kernelcache__gPhysBase = 0xfffffff0079541b8,
        .kernelcache__gPhysSize = 0xfffffff0079541b8 + 8,
        .kernelcache__gVirtBase = 0xfffffff007952390,
        .kernelcache__perfmon_devices = 0xfffffff00a4b3720,
        .kernelcache__perfmon_dev_open = 0xfffffff007f08a34,
        .kernelcache__ptov_table = 0xfffffff007907278,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a4b2b10,
        .kernelcache__vm_pages = 0xfffffff007903fb0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff007906218,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a4b2b08,
        .kernelcache__vn_kqfilter = 0xfffffff007f5794c,
    },
};
