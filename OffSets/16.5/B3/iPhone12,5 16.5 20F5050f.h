...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.5.0: Sun Apr 16 16:47:39 PDT 2023; root:xnu-8796.120.47.0.1~37/RELEASE_ARM64_T8030",
        ...
        .kernelcache__cdevsw = 0xfffffff00a4c1ab0,
        .kernelcache__gPhysBase = 0xfffffff0079641b8,
        .kernelcache__gPhysSize = 0xfffffff0079641b8 + 8,
        .kernelcache__gVirtBase = 0xfffffff007962390,
        .kernelcache__perfmon_devices = 0xfffffff00a4ff720,
        .kernelcache__perfmon_dev_open = 0xfffffff007f1ca34,
        .kernelcache__ptov_table = 0xfffffff007917278,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a4feb10,
        .kernelcache__vm_pages = 0xfffffff007913fb0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff007916218,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a4feb08,
        .kernelcache__vn_kqfilter = 0xfffffff007f6b94c,
    },
};
