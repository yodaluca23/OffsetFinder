...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__gPhysBase = 0xfffffff007918288,
        .kernelcache__gPhysSize = 0xfffffff007918288 + 8,
        .kernelcache__gVirtBase = 0xfffffff007916460,
        .kernelcache__perfmon_devices = 0xfffffff00a423730,
        .kernelcache__perfmon_dev_open = 0xfffffff007ec70f0,
        .kernelcache__ptov_table = 0xfffffff0078cb260,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a422b10,
        .kernelcache__vm_pages = 0xfffffff0078c7fa8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0078ca210,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a422b08,
        .kernelcache__vn_kqfilter = 0xfffffff007f16008,
    },
};
