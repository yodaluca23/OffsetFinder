...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.5.0: Mon Apr 24 21:56:01 PDT 2023; root:xnu-8796.122.4~2/RELEASE_ARM64_T8110",
        ...
        .kernelcache__cdevsw = 0xfffffff00a4f9a30,
        ...
        .kernelcache__perfmon_devices = 0xfffffff00a537750,
        .kernelcache__perfmon_dev_open = 0xfffffff007f16820,
        .kernelcache__ptov_table = 0xfffffff0078ff280,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a536b10,
        .kernelcache__vm_pages = 0xfffffff0078fbfc0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0078fe230,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a536b08,
        .kernelcache__vn_kqfilter = 0xfffffff007f6342c,
    },
};
