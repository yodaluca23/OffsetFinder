...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.5.0: Mon Apr 24 21:56:04 PDT 2023; root:xnu-8796.122.4~2/RELEASE_ARM64_T8101",
        ...
        .kernelcache__perfmon_devices = 0xfffffff00a583750,
        .kernelcache__perfmon_dev_open = 0xfffffff007f15d48,
        .kernelcache__ptov_table = 0xfffffff0078f7288,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a582b10,
        .kernelcache__vm_pages = 0xfffffff0078f3fb8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0078f6228,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a582b08,
        .kernelcache__vn_kqfilter = 0xfffffff007f64f98,
    },
};
