...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__gPhysBase = 0xfffffff00782fbc0,
        .kernelcache__gPhysSize = 0xfffffff00782fbc0 + 8,
        .kernelcache__gVirtBase = 0xfffffff00782dda0,
        .kernelcache__perfmon_devices = 0xfffffff00a329530,
        .kernelcache__perfmon_dev_open = 0xfffffff007e9bd18,
        ...
        .kernelcache__vn_kqfilter = 0xfffffff007eee294,
    },
};
