...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__gPhysBase = 0xfffffff00787faf8,
        .kernelcache__gPhysSize = 0xfffffff00787faf8 + 8,
        .kernelcache__gVirtBase = 0xfffffff00787dcd8,
        .kernelcache__perfmon_devices = 0xfffffff00a425520,
        .kernelcache__perfmon_dev_open = 0xfffffff007ef5560,
        .kernelcache__ptov_table = 0xfffffff007833360,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a424900,
        .kernelcache__vm_pages = 0xfffffff007830188,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff007832310,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a4248f8,
        .kernelcache__vn_kqfilter = 0xfffffff007f477a4,
    },
};
