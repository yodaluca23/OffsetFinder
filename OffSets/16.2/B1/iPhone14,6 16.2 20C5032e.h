...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a4699c0,
        .kernelcache__gPhysBase = 0xfffffff007874028,
        .kernelcache__gPhysSize = 0xfffffff007874028 + 8,
        .kernelcache__gVirtBase = 0xfffffff007872208,
        .kernelcache__perfmon_devices = 0xfffffff00a4a5560,
        .kernelcache__perfmon_dev_open = 0xfffffff007f0d750,
        .kernelcache__ptov_table = 0xfffffff007827470,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a4a4900,
        .kernelcache__vm_pages = 0xfffffff007824198,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff007826430,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a4a48f8,
        .kernelcache__vn_kqfilter = 0xfffffff007f5d680,
    },
};
