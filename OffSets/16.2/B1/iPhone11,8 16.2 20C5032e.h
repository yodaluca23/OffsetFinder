...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.2.0: Sun Oct 16 17:48:37 PDT 2022; root:xnu-8792.60.32.0.1~10/RELEASE_ARM64_T8020",
        ...
        .kernelcache__gPhysBase = 0xfffffff007807bc0,
        .kernelcache__gPhysSize = 0xfffffff007807bc0 + 8,
        .kernelcache__gVirtBase = 0xfffffff007805da0,
        .kernelcache__perfmon_devices = 0xfffffff00a1a9530,
        .kernelcache__perfmon_dev_open = 0xfffffff007e53d18,
        .kernelcache__ptov_table = 0xfffffff0077bb348,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a1a8900,
        .kernelcache__vm_pages = 0xfffffff0077b8180,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0077ba308,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a1a88f8,
        .kernelcache__vn_kqfilter = 0xfffffff007ea6294,
    },
};
