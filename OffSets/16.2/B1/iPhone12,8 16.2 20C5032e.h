...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.2.0: Sun Oct 16 17:48:38 PDT 2022; root:xnu-8792.60.32.0.1~10/RELEASE_ARM64_T8030",
        ...
        .kernelcache__cdevsw = 0xfffffff00a39d9a8,
        .kernelcache__gPhysBase = 0xfffffff00786faf8,
        .kernelcache__gPhysSize = 0xfffffff00786faf8 + 8,
        .kernelcache__gVirtBase = 0xfffffff00786dcd8,
        .kernelcache__perfmon_devices = 0xfffffff00a3d9520,
        .kernelcache__perfmon_dev_open = 0xfffffff007ee1560,
        .kernelcache__ptov_table = 0xfffffff007823360,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a3d8900,
        .kernelcache__vm_pages = 0xfffffff007820188,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff007822310,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a3d88f8,
        .kernelcache__vn_kqfilter = 0xfffffff007f337a4,
    },
};
