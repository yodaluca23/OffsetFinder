...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.2.0: Sun Oct 16 17:49:03 PDT 2022; root:xnu-8792.60.32.0.1~10/RELEASE_ARM64_T8101",
        ...
        .kernelcache__cdevsw = 0xfffffff00a43d9c0,
        .kernelcache__gPhysBase = 0xfffffff00785c028,
        .kernelcache__gPhysSize = 0xfffffff00785c028 + 8,
        .kernelcache__gVirtBase = 0xfffffff00785a208,
        .kernelcache__perfmon_devices = 0xfffffff00a479560,
        .kernelcache__perfmon_dev_open = 0xfffffff007ef0af8,
        .kernelcache__ptov_table = 0xfffffff00780f478,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a478900,
        .kernelcache__vm_pages = 0xfffffff00780c190,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff00780e428,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a4788f8,
        .kernelcache__vn_kqfilter = 0xfffffff007f42fbc,
    },
};
