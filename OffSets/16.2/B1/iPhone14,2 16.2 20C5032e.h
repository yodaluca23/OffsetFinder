...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.2.0: Sun Oct 16 17:48:36 PDT 2022; root:xnu-8792.60.32.0.1~10/RELEASE_ARM64_T8110",
        ...
        .kernelcache__cdevsw = 0xfffffff00a4059c0,
        .kernelcache__gPhysBase = 0xfffffff007864028,
        .kernelcache__gPhysSize = 0xfffffff007864028 + 8,
        .kernelcache__gVirtBase = 0xfffffff007862208,
        .kernelcache__perfmon_devices = 0xfffffff00a441560,
        .kernelcache__perfmon_dev_open = 0xfffffff007ef5750,
        .kernelcache__ptov_table = 0xfffffff007817470,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a440900,
        .kernelcache__vm_pages = 0xfffffff007814198,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff007816430,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a4408f8,
        .kernelcache__vn_kqfilter = 0xfffffff007f45680,
    },
};
