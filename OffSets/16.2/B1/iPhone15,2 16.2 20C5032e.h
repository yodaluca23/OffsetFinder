...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.2.0: Sun Oct 16 17:47:55 PDT 2022; root:xnu-8792.60.32.0.1~10/RELEASE_ARM64_T8120",
        ...
        .kernelcache__cdevsw = 0xfffffff00a3b59c0,
        .kernelcache__gPhysBase = 0xfffffff00785ff38,
        .kernelcache__gPhysSize = 0xfffffff00785ff38 + 8,
        .kernelcache__gVirtBase = 0xfffffff00785e118,
        .kernelcache__perfmon_devices = 0xfffffff00a3f1540,
        .kernelcache__perfmon_dev_open = 0xfffffff007ee9624,
        .kernelcache__ptov_table = 0xfffffff0078134d0,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a3f0900,
        .kernelcache__vm_pages = 0xfffffff007810190,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff007812490,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a3f08f8,
        .kernelcache__vn_kqfilter = 0xfffffff007f39554,
    },
};
