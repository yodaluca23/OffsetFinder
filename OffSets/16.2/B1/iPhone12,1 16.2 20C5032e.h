...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a3e19a8,
        .kernelcache__gPhysBase = 0xfffffff00787baf8,
        .kernelcache__gPhysSize = 0xfffffff00787baf8 + 8,
        .kernelcache__gVirtBase = 0xfffffff007879cd8,
        .kernelcache__perfmon_devices = 0xfffffff00a41d520,
        .kernelcache__perfmon_dev_open = 0xfffffff007ef1560,
        .kernelcache__ptov_table = 0xfffffff00782f360,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a41c900,
        .kernelcache__vm_pages = 0xfffffff00782c188,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff00782e310,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a41c8f8,
        .kernelcache__vn_kqfilter = 0xfffffff007f437a4,
    },
};
