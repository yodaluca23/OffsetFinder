...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__gPhysBase = 0xfffffff007860028,
        .kernelcache__gPhysSize = 0xfffffff007860028 + 8,
        .kernelcache__gVirtBase = 0xfffffff00785e208,
        .kernelcache__perfmon_devices = 0xfffffff00a425560,
        .kernelcache__perfmon_dev_open = 0xfffffff007eed750,
        .kernelcache__ptov_table = 0xfffffff007813470,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a424900,
        .kernelcache__vm_pages = 0xfffffff007810198,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff007812430,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a4248f8,
        .kernelcache__vn_kqfilter = 0xfffffff007f3d680,
    },
};
