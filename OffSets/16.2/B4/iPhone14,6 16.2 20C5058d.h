...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a3f19c0,
        ...
        .kernelcache__perfmon_devices = 0xfffffff00a42d5e0,
        .kernelcache__perfmon_dev_open = 0xfffffff007efe250,
        .kernelcache__ptov_table = 0xfffffff00781b470,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a42c980,
        .kernelcache__vm_pages = 0xfffffff007818198,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff00781a430,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a42c978,
        .kernelcache__vn_kqfilter = 0xfffffff007f4e290,
    },
};
