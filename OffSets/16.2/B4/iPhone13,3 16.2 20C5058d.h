...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.2.0: Mon Nov 14 21:23:51 PST 2022; root:xnu-8792.62.1~2/RELEASE_ARM64_T8101",
        ...
        .kernelcache__cdevsw = 0xfffffff00a3cd9c0,
        ...
        .kernelcache__perfmon_devices = 0xfffffff00a4095e0,
        .kernelcache__perfmon_dev_open = 0xfffffff007ee55a8,
        .kernelcache__ptov_table = 0xfffffff007803478,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a408980,
        .kernelcache__vm_pages = 0xfffffff007800190,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff007802428,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a408978,
        .kernelcache__vn_kqfilter = 0xfffffff007f37b7c,
    },
};
