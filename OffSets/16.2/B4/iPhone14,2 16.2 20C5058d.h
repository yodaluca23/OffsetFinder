...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a38d9c0,
        ...
        .kernelcache__perfmon_devices = 0xfffffff00a3c95e0,
        .kernelcache__perfmon_dev_open = 0xfffffff007ee6250,
        .kernelcache__ptov_table = 0xfffffff00780b470,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a3c8980,
        .kernelcache__vm_pages = 0xfffffff007808198,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff00780a430,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a3c8978,
        .kernelcache__vn_kqfilter = 0xfffffff007f36290,
    },
};
