...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.2.0: Mon Nov 14 21:24:22 PST 2022; root:xnu-8792.62.1~2/RELEASE_ARM64_T8030",
        ...
        .kernelcache__perfmon_dev_open = 0xfffffff007ece010,
        .kernelcache__ptov_table = 0xfffffff007813360,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a368980,
        .kernelcache__vm_pages = 0xfffffff007810188,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff007812310,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a368978,
        .kernelcache__vn_kqfilter = 0xfffffff007f20364,
    },
};
