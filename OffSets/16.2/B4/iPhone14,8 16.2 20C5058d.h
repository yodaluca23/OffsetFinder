...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.2.0: Mon Nov 14 21:24:23 PST 2022; root:xnu-8792.62.1~2/RELEASE_ARM64_T8110",
        ...
        .kernelcache__cdevsw = 0xfffffff00a3719c0,
        ...
        .kernelcache__perfmon_devices = 0xfffffff00a3ad5e0,
        .kernelcache__perfmon_dev_open = 0xfffffff007ede250,
        .kernelcache__ptov_table = 0xfffffff007807470,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a3ac980,
        .kernelcache__vm_pages = 0xfffffff007804198,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff007806430,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a3ac978,
        .kernelcache__vn_kqfilter = 0xfffffff007f2e290,
    },
};
