...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.2.0: Mon Nov 14 21:23:34 PST 2022; root:xnu-8792.62.1~2/RELEASE_ARM64_T8020",
        ...
        .kernelcache__gPhysBase = 0xfffffff00781fdf0,
        .kernelcache__gPhysSize = 0xfffffff00781fdf0 + 8,
        .kernelcache__gVirtBase = 0xfffffff00781dfd0,
        .kernelcache__perfmon_devices = 0xfffffff00a28d5b0,
        .kernelcache__perfmon_dev_open = 0xfffffff007e887e4,
        .kernelcache__ptov_table = 0xfffffff0077d3348,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a28c980,
        .kernelcache__vm_pages = 0xfffffff0077d0180,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0077d2308,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a28c978,
        .kernelcache__vn_kqfilter = 0xfffffff007edae94,
    },
};
