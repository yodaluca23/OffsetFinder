...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__perfmon_dev_open = 0xfffffff007e4c7e4,
        .kernelcache__ptov_table = 0xfffffff0077b3348,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a14c980,
        .kernelcache__vm_pages = 0xfffffff0077b0180,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0077b2308,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a14c978,
        .kernelcache__vn_kqfilter = 0xfffffff007e9ee94,
    },
};
