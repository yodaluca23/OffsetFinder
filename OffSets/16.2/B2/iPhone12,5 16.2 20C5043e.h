...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a3ed9a8,
        ...
        .kernelcache__perfmon_devices = 0xfffffff00a4295a0,
        .kernelcache__perfmon_dev_open = 0xfffffff007ef59d8,
        .kernelcache__ptov_table = 0xfffffff007833360,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a428980,
        .kernelcache__vm_pages = 0xfffffff007830188,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff007832310,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a428978,
        .kernelcache__vn_kqfilter = 0xfffffff007f47d2c,
    },
};
