...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.2.0: Tue Nov  1 21:20:55 PDT 2022; root:xnu-8792.60.51.122.1~1/RELEASE_ARM64_T8110",
        ...
        .kernelcache__cdevsw = 0xfffffff00a3e99c0,
        .kernelcache__gPhysBase = 0xfffffff007864258,
        .kernelcache__gPhysSize = 0xfffffff007864258 + 8,
        .kernelcache__gVirtBase = 0xfffffff007862438,
        .kernelcache__perfmon_devices = 0xfffffff00a4255e0,
        .kernelcache__perfmon_dev_open = 0xfffffff007eedbd8,
        .kernelcache__ptov_table = 0xfffffff007817470,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a424980,
        .kernelcache__vm_pages = 0xfffffff007814198,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff007816430,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a424978,
        .kernelcache__vn_kqfilter = 0xfffffff007f3dc18,
    },
};
