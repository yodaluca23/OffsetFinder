...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.2.0: Tue Nov  1 21:20:53 PDT 2022; root:xnu-8792.60.51.122.1~1/RELEASE_ARM64_T8030",
        ...
        .kernelcache__cdevsw = 0xfffffff00a3a19a8,
        ...
        .kernelcache__perfmon_devices = 0xfffffff00a3dd5a0,
        .kernelcache__perfmon_dev_open = 0xfffffff007ee19d8,
        .kernelcache__ptov_table = 0xfffffff007823360,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a3dc980,
        .kernelcache__vm_pages = 0xfffffff007820188,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff007822310,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a3dc978,
        .kernelcache__vn_kqfilter = 0xfffffff007f33d2c,
    },
};
