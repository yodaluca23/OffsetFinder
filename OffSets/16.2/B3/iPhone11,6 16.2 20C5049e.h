...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a2ed9a8,
        .kernelcache__gPhysBase = 0xfffffff00782fdf0,
        .kernelcache__gPhysSize = 0xfffffff00782fdf0 + 8,
        .kernelcache__gVirtBase = 0xfffffff00782dfd0,
        .kernelcache__perfmon_devices = 0xfffffff00a3295b0,
        .kernelcache__perfmon_dev_open = 0xfffffff007e9c15c,
        .kernelcache__ptov_table = 0xfffffff0077e3348,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a328980,
        .kernelcache__vm_pages = 0xfffffff0077e0180,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0077e2308,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a328978,
        .kernelcache__vn_kqfilter = 0xfffffff007eee80c,
    },
};
