...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.2.0: Tue Nov  8 21:16:06 PST 2022; root:xnu-8792.60.55.132.1~1/RELEASE_ARM64_T8020",
        ...
        .kernelcache__cdevsw = 0xfffffff00a16d9a8,
        .kernelcache__gPhysBase = 0xfffffff007807df0,
        .kernelcache__gPhysSize = 0xfffffff007807df0 + 8,
        .kernelcache__gVirtBase = 0xfffffff007805fd0,
        .kernelcache__perfmon_devices = 0xfffffff00a1a95b0,
        .kernelcache__perfmon_dev_open = 0xfffffff007e5415c,
        .kernelcache__ptov_table = 0xfffffff0077bb348,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a1a8980,
        .kernelcache__vm_pages = 0xfffffff0077b8180,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0077ba308,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a1a8978,
        .kernelcache__vn_kqfilter = 0xfffffff007ea680c,
    },
};
