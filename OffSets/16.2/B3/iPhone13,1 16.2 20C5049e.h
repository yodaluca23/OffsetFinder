...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.2.0: Tue Nov  8 21:16:34 PST 2022; root:xnu-8792.60.55.132.1~1/RELEASE_ARM64_T8101",
        ...
        .kernelcache__cdevsw = 0xfffffff00a4419c0,
        ...
        .kernelcache__perfmon_devices = 0xfffffff00a47d5e0,
        .kernelcache__perfmon_dev_open = 0xfffffff007ef0f5c,
        .kernelcache__ptov_table = 0xfffffff00780f478,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a47c980,
        .kernelcache__vm_pages = 0xfffffff00780c190,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff00780e428,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a47c978,
        .kernelcache__vn_kqfilter = 0xfffffff007f43530,
    },
};
