...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.2.0: Tue Nov  8 21:16:11 PST 2022; root:xnu-8792.60.55.132.1~1/RELEASE_ARM64_T8120",
        ...
        .kernelcache__cdevsw = 0xfffffff00a3b19c0,
        .kernelcache__gPhysBase = 0xfffffff007860168,
        .kernelcache__gPhysSize = 0xfffffff007860168 + 8,
        .kernelcache__gVirtBase = 0xfffffff00785e348,
        .kernelcache__perfmon_devices = 0xfffffff00a3ed5c0,
        .kernelcache__perfmon_dev_open = 0xfffffff007ee5a88,
        .kernelcache__ptov_table = 0xfffffff0078134d0,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a3ec980,
        .kernelcache__vm_pages = 0xfffffff007810190,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff007812490,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a3ec978,
        .kernelcache__vn_kqfilter = 0xfffffff007f35ac8,
    },
};
