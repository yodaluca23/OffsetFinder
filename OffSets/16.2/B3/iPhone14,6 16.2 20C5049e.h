...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a4659c0,
        ...
        .kernelcache__perfmon_devices = 0xfffffff00a4a15e0,
        .kernelcache__perfmon_dev_open = 0xfffffff007f09bb4,
        .kernelcache__ptov_table = 0xfffffff007827470,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a4a0980,
        .kernelcache__vm_pages = 0xfffffff007824198,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff007826430,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a4a0978,
        .kernelcache__vn_kqfilter = 0xfffffff007f59bf4,
    },
};
