...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__gPhysBase = 0xfffffff0079500c8,
        .kernelcache__gPhysSize = 0xfffffff0079500c8 + 8,
        .kernelcache__gVirtBase = 0xfffffff00794e2a0,
        .kernelcache__perfmon_devices = 0xfffffff00a547750,
        .kernelcache__perfmon_dev_open = 0xfffffff007f1e560,
        .kernelcache__ptov_table = 0xfffffff007903280,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a546b10,
        .kernelcache__vm_pages = 0xfffffff0078fffc0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff007902230,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a546b08,
        .kernelcache__vn_kqfilter = 0xfffffff007f6ad34,
    },
};
