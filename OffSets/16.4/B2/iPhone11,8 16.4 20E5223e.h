...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a235a30,
        .kernelcache__gPhysBase = 0xfffffff0078ec0a8,
        .kernelcache__gPhysSize = 0xfffffff0078ec0a8 + 8,
        .kernelcache__gVirtBase = 0xfffffff0078ea280,
        .kernelcache__perfmon_devices = 0xfffffff00a273730,
        .kernelcache__perfmon_dev_open = 0xfffffff007e7aedc,
        .kernelcache__ptov_table = 0xfffffff00789f260,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a272b10,
        .kernelcache__vm_pages = 0xfffffff00789bfa8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff00789e210,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a272b08,
        .kernelcache__vn_kqfilter = 0xfffffff007ec998c,
    },
};
