...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.4.0: Wed Feb 22 21:02:22 PST 2023; root:xnu-8796.100.763.502.1~1/RELEASE_ARM64_T8110",
        ...
        .kernelcache__cdevsw = 0xfffffff00a569a30,
        .kernelcache__gPhysBase = 0xfffffff0079600c8,
        .kernelcache__gPhysSize = 0xfffffff0079600c8 + 8,
        .kernelcache__gVirtBase = 0xfffffff00795e2a0,
        .kernelcache__perfmon_devices = 0xfffffff00a5a7750,
        .kernelcache__perfmon_dev_open = 0xfffffff007f36560,
        .kernelcache__ptov_table = 0xfffffff007913280,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a5a6b10,
        .kernelcache__vm_pages = 0xfffffff00790ffc0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff007912230,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a5a6b08,
        .kernelcache__vn_kqfilter = 0xfffffff007f82d34,
    },
};
