...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.4.0: Wed Feb 22 21:02:36 PST 2023; root:xnu-8796.100.763.502.1~1/RELEASE_ARM64_T8030",
        ...
        .kernelcache__cdevsw = 0xfffffff00a4b5a30,
        .kernelcache__gPhysBase = 0xfffffff007963fd8,
        .kernelcache__gPhysSize = 0xfffffff007963fd8 + 8,
        .kernelcache__gVirtBase = 0xfffffff0079621b0,
        .kernelcache__perfmon_devices = 0xfffffff00a4f3720,
        .kernelcache__perfmon_dev_open = 0xfffffff007f1c81c,
        .kernelcache__ptov_table = 0xfffffff007917278,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a4f2b10,
        .kernelcache__vm_pages = 0xfffffff007913fb0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff007916218,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a4f2b08,
        .kernelcache__vn_kqfilter = 0xfffffff007f6b2cc,
    },
};
