...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.4.0: Wed Feb 22 21:02:40 PST 2023; root:xnu-8796.100.763.502.1~1/RELEASE_ARM64_T8120",
        ...
        .kernelcache__gPhysBase = 0xfffffff00794bfd8,
        .kernelcache__gPhysSize = 0xfffffff00794bfd8 + 8,
        .kernelcache__gVirtBase = 0xfffffff00794a1b0,
        .kernelcache__perfmon_devices = 0xfffffff00a4f3730,
        .kernelcache__perfmon_dev_open = 0xfffffff007f1208c,
        .kernelcache__ptov_table = 0xfffffff0078ff278,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a4f2b10,
        .kernelcache__vm_pages = 0xfffffff0078fbfb8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0078fe228,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a4f2b08,
        .kernelcache__vn_kqfilter = 0xfffffff007f5e860,
    },
};
