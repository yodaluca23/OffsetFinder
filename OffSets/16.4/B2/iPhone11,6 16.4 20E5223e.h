...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.4.0: Wed Feb 22 21:01:10 PST 2023; root:xnu-8796.100.763.502.1~1/RELEASE_ARM64_T8020",
        ...
        .kernelcache__cdevsw = 0xfffffff00a3d1a30,
        .kernelcache__gPhysBase = 0xfffffff0079140a8,
        .kernelcache__gPhysSize = 0xfffffff0079140a8 + 8,
        .kernelcache__gVirtBase = 0xfffffff007912280,
        .kernelcache__perfmon_devices = 0xfffffff00a40f730,
        .kernelcache__perfmon_dev_open = 0xfffffff007ec2edc,
        .kernelcache__ptov_table = 0xfffffff0078c7260,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a40eb10,
        .kernelcache__vm_pages = 0xfffffff0078c3fa8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0078c6210,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a40eb08,
        .kernelcache__vn_kqfilter = 0xfffffff007f1198c,
    },
};
