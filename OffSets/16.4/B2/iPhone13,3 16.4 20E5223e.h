...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.4.0: Wed Feb 22 21:02:40 PST 2023; root:xnu-8796.100.763.502.1~1/RELEASE_ARM64_T8101",
        ...
        .kernelcache__cdevsw = 0xfffffff00a531a30,
        .kernelcache__gPhysBase = 0xfffffff0079440c8,
        .kernelcache__gPhysSize = 0xfffffff0079440c8 + 8,
        .kernelcache__gVirtBase = 0xfffffff0079422a0,
        .kernelcache__perfmon_devices = 0xfffffff00a56f750,
        .kernelcache__perfmon_dev_open = 0xfffffff007f15af8,
        .kernelcache__ptov_table = 0xfffffff0078f7288,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a56eb10,
        .kernelcache__vm_pages = 0xfffffff0078f3fb8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0078f6228,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a56eb08,
        .kernelcache__vn_kqfilter = 0xfffffff007f64904,
    },
};
