...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.4.0: Tue Feb 28 22:16:22 PST 2023; root:xnu-8796.100.772.502.1~1/RELEASE_ARM64_T8110",
        ...
        .kernelcache__gPhysBase = 0xfffffff00795c168,
        .kernelcache__gPhysSize = 0xfffffff00795c168 + 8,
        .kernelcache__gVirtBase = 0xfffffff00795a340,
        .kernelcache__perfmon_devices = 0xfffffff00a5a7750,
        .kernelcache__perfmon_dev_open = 0xfffffff007f32568,
        .kernelcache__ptov_table = 0xfffffff00790f280,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a5a6b10,
        .kernelcache__vm_pages = 0xfffffff00790bfc0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff00790e230,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a5a6b08,
        .kernelcache__vn_kqfilter = 0xfffffff007f7eedc,
    },
};
