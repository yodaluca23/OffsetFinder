...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a23da30,
        .kernelcache__gPhysBase = 0xfffffff0078ec148,
        .kernelcache__gPhysSize = 0xfffffff0078ec148 + 8,
        .kernelcache__gVirtBase = 0xfffffff0078ea320,
        .kernelcache__perfmon_devices = 0xfffffff00a27b730,
        .kernelcache__perfmon_dev_open = 0xfffffff007e7aee4,
        .kernelcache__ptov_table = 0xfffffff00789f260,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a27ab10,
        .kernelcache__vm_pages = 0xfffffff00789bfa8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff00789e210,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a27ab08,
        .kernelcache__vn_kqfilter = 0xfffffff007ec9b64,
    },
};
