...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.4.0: Tue Feb 28 22:17:59 PST 2023; root:xnu-8796.100.772.502.1~1/RELEASE_ARM64_T8120",
        ...
        .kernelcache__gPhysBase = 0xfffffff007948078,
        .kernelcache__gPhysSize = 0xfffffff007948078 + 8,
        .kernelcache__gVirtBase = 0xfffffff007946250,
        .kernelcache__perfmon_devices = 0xfffffff00a4f3730,
        .kernelcache__perfmon_dev_open = 0xfffffff007f0e094,
        .kernelcache__ptov_table = 0xfffffff0078fb278,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a4f2b10,
        .kernelcache__vm_pages = 0xfffffff0078f7fb8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0078fa228,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a4f2b08,
        .kernelcache__vn_kqfilter = 0xfffffff007f5aa08,
    },
};
