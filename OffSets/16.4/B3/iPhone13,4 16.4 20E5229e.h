...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.4.0: Tue Feb 28 22:16:19 PST 2023; root:xnu-8796.100.772.502.1~1/RELEASE_ARM64_T8101",
        ...
        .kernelcache__cdevsw = 0xfffffff00a535a30,
        .kernelcache__gPhysBase = 0xfffffff007944168,
        .kernelcache__gPhysSize = 0xfffffff007944168 + 8,
        .kernelcache__gVirtBase = 0xfffffff007942340,
        .kernelcache__perfmon_devices = 0xfffffff00a573750,
        .kernelcache__perfmon_dev_open = 0xfffffff007f15b00,
        .kernelcache__ptov_table = 0xfffffff0078f7288,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a572b10,
        .kernelcache__vm_pages = 0xfffffff0078f3fb8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0078f6228,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a572b08,
        .kernelcache__vn_kqfilter = 0xfffffff007f64ab8,
    },
};
