...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a509a30,
        .kernelcache__gPhysBase = 0xfffffff00794c168,
        .kernelcache__gPhysSize = 0xfffffff00794c168 + 8,
        .kernelcache__gVirtBase = 0xfffffff00794a340,
        .kernelcache__perfmon_devices = 0xfffffff00a547750,
        .kernelcache__perfmon_dev_open = 0xfffffff007f1a568,
        .kernelcache__ptov_table = 0xfffffff0078ff280,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a546b10,
        .kernelcache__vm_pages = 0xfffffff0078fbfc0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0078fe230,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a546b08,
        .kernelcache__vn_kqfilter = 0xfffffff007f66edc,
    },
};
