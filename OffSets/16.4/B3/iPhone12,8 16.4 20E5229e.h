...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a46da30,
        .kernelcache__gPhysBase = 0xfffffff007954078,
        .kernelcache__gPhysSize = 0xfffffff007954078 + 8,
        .kernelcache__gVirtBase = 0xfffffff007952250,
        .kernelcache__perfmon_devices = 0xfffffff00a4ab720,
        .kernelcache__perfmon_dev_open = 0xfffffff007f08824,
        .kernelcache__ptov_table = 0xfffffff007907278,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a4aab10,
        .kernelcache__vm_pages = 0xfffffff007903fb0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff007906218,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a4aab08,
        .kernelcache__vn_kqfilter = 0xfffffff007f574a4,
    },
};
