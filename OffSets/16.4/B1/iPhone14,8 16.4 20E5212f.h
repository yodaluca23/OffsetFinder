...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.4.0: Fri Feb 10 07:13:28 PST 2023; root:xnu-8796.100.721.502.1~3/RELEASE_ARM64_T8110",
        ...
        .kernelcache__cdevsw = 0xfffffff00a4dda30,
        .kernelcache__gPhysBase = 0xfffffff007948228,
        .kernelcache__gPhysSize = 0xfffffff007948228 + 8,
        .kernelcache__gVirtBase = 0xfffffff007946400,
        .kernelcache__perfmon_devices = 0xfffffff00a51b790,
        .kernelcache__perfmon_dev_open = 0xfffffff007f0e290,
        .kernelcache__ptov_table = 0xfffffff0078fb280,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a51ab18,
        .kernelcache__vm_pages = 0xfffffff0078f7fc8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0078fa230,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a51ab10,
        .kernelcache__vn_kqfilter = 0xfffffff007f5a9b4,
    },
};
