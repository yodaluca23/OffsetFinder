...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.4.0: Fri Feb 10 07:12:53 PST 2023; root:xnu-8796.100.721.502.1~3/RELEASE_ARM64_T8120",
        ...
        .kernelcache__cdevsw = 0xfffffff00a4a5a30,
        .kernelcache__gPhysBase = 0xfffffff007944138,
        .kernelcache__gPhysSize = 0xfffffff007944138 + 8,
        .kernelcache__gVirtBase = 0xfffffff007942310,
        .kernelcache__perfmon_devices = 0xfffffff00a4e3770,
        .kernelcache__perfmon_dev_open = 0xfffffff007f05dbc,
        .kernelcache__ptov_table = 0xfffffff0078f7278,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a4e2b18,
        .kernelcache__vm_pages = 0xfffffff0078f3fc0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0078f6228,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a4e2b10,
        .kernelcache__vn_kqfilter = 0xfffffff007f524e0,
    },
};
