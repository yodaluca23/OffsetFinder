...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__gPhysBase = 0xfffffff007960138,
        .kernelcache__gPhysSize = 0xfffffff007960138 + 8,
        .kernelcache__gVirtBase = 0xfffffff00795e310,
        .kernelcache__perfmon_devices = 0xfffffff00a4e3760,
        .kernelcache__perfmon_dev_open = 0xfffffff007f145b8,
        .kernelcache__ptov_table = 0xfffffff007913278,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a4e2b18,
        .kernelcache__vm_pages = 0xfffffff00790ffb8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff007912218,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a4e2b10,
        .kernelcache__vn_kqfilter = 0xfffffff007f63064,
    },
};
