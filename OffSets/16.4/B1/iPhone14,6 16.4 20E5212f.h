...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a55da30,
        .kernelcache__gPhysBase = 0xfffffff007958228,
        .kernelcache__gPhysSize = 0xfffffff007958228 + 8,
        .kernelcache__gVirtBase = 0xfffffff007956400,
        .kernelcache__perfmon_devices = 0xfffffff00a59b790,
        .kernelcache__perfmon_dev_open = 0xfffffff007f2a290,
        .kernelcache__ptov_table = 0xfffffff00790b280,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a59ab18,
        .kernelcache__vm_pages = 0xfffffff007907fc8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff00790a230,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a59ab10,
        .kernelcache__vn_kqfilter = 0xfffffff007f769b4,
    },
};
