...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a45da30,
        .kernelcache__gPhysBase = 0xfffffff007950138,
        .kernelcache__gPhysSize = 0xfffffff007950138 + 8,
        .kernelcache__gVirtBase = 0xfffffff00794e310,
        .kernelcache__perfmon_devices = 0xfffffff00a49b760,
        .kernelcache__perfmon_dev_open = 0xfffffff007f005b8,
        .kernelcache__ptov_table = 0xfffffff007903278,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a49ab18,
        .kernelcache__vm_pages = 0xfffffff0078fffb8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff007902218,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a49ab10,
        .kernelcache__vn_kqfilter = 0xfffffff007f4f064,
    },
};
