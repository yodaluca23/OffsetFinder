...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.4.0: Fri Feb 10 07:15:03 PST 2023; root:xnu-8796.100.721.502.1~3/RELEASE_ARM64_T8101",
        ...
        .kernelcache__cdevsw = 0xfffffff00a525a30,
        .kernelcache__gPhysBase = 0xfffffff007940228,
        .kernelcache__gPhysSize = 0xfffffff007940228 + 8,
        .kernelcache__gVirtBase = 0xfffffff00793e400,
        .kernelcache__perfmon_devices = 0xfffffff00a563790,
        .kernelcache__perfmon_dev_open = 0xfffffff007f0d820,
        .kernelcache__ptov_table = 0xfffffff0078f3288,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a562b18,
        .kernelcache__vm_pages = 0xfffffff0078effc0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0078f2228,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a562b10,
        .kernelcache__vn_kqfilter = 0xfffffff007f5c57c,
    },
};
