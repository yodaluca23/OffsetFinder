...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a3c1a30,
        .kernelcache__gPhysBase = 0xfffffff00790c208,
        .kernelcache__gPhysSize = 0xfffffff00790c208 + 8,
        .kernelcache__gVirtBase = 0xfffffff00790a3e0,
        .kernelcache__perfmon_devices = 0xfffffff00a3ff770,
        .kernelcache__perfmon_dev_open = 0xfffffff007eb6c78,
        .kernelcache__ptov_table = 0xfffffff0078bf260,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a3feb18,
        .kernelcache__vm_pages = 0xfffffff0078bbfb0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0078be210,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a3feb10,
        .kernelcache__vn_kqfilter = 0xfffffff007f05724,
    },
};
