...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__gPhysBase = 0xfffffff00794c228,
        .kernelcache__gPhysSize = 0xfffffff00794c228 + 8,
        .kernelcache__gVirtBase = 0xfffffff00794a400,
        .kernelcache__perfmon_devices = 0xfffffff00a53b790,
        .kernelcache__perfmon_dev_open = 0xfffffff007f16290,
        .kernelcache__ptov_table = 0xfffffff0078ff280,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a53ab18,
        .kernelcache__vm_pages = 0xfffffff0078fbfc8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0078fe230,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a53ab10,
        .kernelcache__vn_kqfilter = 0xfffffff007f629b4,
    },
};
