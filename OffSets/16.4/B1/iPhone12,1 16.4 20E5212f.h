...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.4.0: Fri Feb 10 07:14:26 PST 2023; root:xnu-8796.100.721.502.1~3/RELEASE_ARM64_T8030",
        ...
        .kernelcache__cdevsw = 0xfffffff00a49da30,
        .kernelcache__gPhysBase = 0xfffffff00795c138,
        .kernelcache__gPhysSize = 0xfffffff00795c138 + 8,
        .kernelcache__gVirtBase = 0xfffffff00795a310,
        .kernelcache__perfmon_devices = 0xfffffff00a4db760,
        .kernelcache__perfmon_dev_open = 0xfffffff007f105b8,
        .kernelcache__ptov_table = 0xfffffff00790f278,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a4dab18,
        .kernelcache__vm_pages = 0xfffffff00790bfb8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff00790e218,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a4dab10,
        .kernelcache__vn_kqfilter = 0xfffffff007f5f064,
    },
};
