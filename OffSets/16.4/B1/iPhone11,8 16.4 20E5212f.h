...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.4.0: Fri Feb 10 07:14:22 PST 2023; root:xnu-8796.100.721.502.1~3/RELEASE_ARM64_T8020",
        ...
        .kernelcache__cdevsw = 0xfffffff00a225a30,
        .kernelcache__gPhysBase = 0xfffffff0078e4208,
        .kernelcache__gPhysSize = 0xfffffff0078e4208 + 8,
        .kernelcache__gVirtBase = 0xfffffff0078e23e0,
        .kernelcache__perfmon_devices = 0xfffffff00a263770,
        .kernelcache__perfmon_dev_open = 0xfffffff007e6ec78,
        .kernelcache__ptov_table = 0xfffffff007897260,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a262b18,
        .kernelcache__vm_pages = 0xfffffff007893fb0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff007896210,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a262b10,
        .kernelcache__vn_kqfilter = 0xfffffff007ebd724,
    },
};
