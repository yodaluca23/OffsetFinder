...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a3f19b0,
        .kernelcache__gPhysBase = 0xfffffff00787fd28,
        .kernelcache__gPhysSize = 0xfffffff00787fd28 + 8,
        .kernelcache__gVirtBase = 0xfffffff00787df08,
        .kernelcache__perfmon_devices = 0xfffffff00a42d5a0,
        .kernelcache__perfmon_dev_open = 0xfffffff007ef6010,
        .kernelcache__ptov_table = 0xfffffff007833360,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a42c980,
        .kernelcache__vm_pages = 0xfffffff007830188,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff007832310,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a42c978,
        .kernelcache__vn_kqfilter = 0xfffffff007f48364,
    },
};
