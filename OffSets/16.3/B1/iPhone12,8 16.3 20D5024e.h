...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.3.0: Wed Dec  7 19:49:05 PST 2022; root:xnu-8792.80.21.112.1~1/RELEASE_ARM64_T8030",
        ...
        .kernelcache__cdevsw = 0xfffffff00a3a59b0,
        .kernelcache__gPhysBase = 0xfffffff00786fd28,
        .kernelcache__gPhysSize = 0xfffffff00786fd28 + 8,
        .kernelcache__gVirtBase = 0xfffffff00786df08,
        .kernelcache__perfmon_devices = 0xfffffff00a3e15a0,
        .kernelcache__perfmon_dev_open = 0xfffffff007ee2010,
        .kernelcache__ptov_table = 0xfffffff007823360,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a3e0980,
        .kernelcache__vm_pages = 0xfffffff007820188,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff007822310,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a3e0978,
        .kernelcache__vn_kqfilter = 0xfffffff007f34364,
    },
};
