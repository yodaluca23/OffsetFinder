...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.3.0: Wed Dec  7 19:48:42 PST 2022; root:xnu-8792.80.21.112.1~1/RELEASE_ARM64_T8110",
        ...
        .kernelcache__cdevsw = 0xfffffff00a4699c8,
        .kernelcache__gPhysBase = 0xfffffff007874258,
        .kernelcache__gPhysSize = 0xfffffff007874258 + 8,
        .kernelcache__gVirtBase = 0xfffffff007872438,
        .kernelcache__perfmon_devices = 0xfffffff00a4a55e0,
        .kernelcache__perfmon_dev_open = 0xfffffff007f0a250,
        .kernelcache__ptov_table = 0xfffffff007827470,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a4a4980,
        .kernelcache__vm_pages = 0xfffffff007824198,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff007826430,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a4a4978,
        .kernelcache__vn_kqfilter = 0xfffffff007f5a290,
    },
};
