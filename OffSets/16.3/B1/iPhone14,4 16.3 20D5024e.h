...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a4019c8,
        ...
        .kernelcache__perfmon_devices = 0xfffffff00a43d5e0,
        .kernelcache__perfmon_dev_open = 0xfffffff007ef2250,
        .kernelcache__ptov_table = 0xfffffff007817470,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a43c980,
        .kernelcache__vm_pages = 0xfffffff007814198,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff007816430,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a43c978,
        .kernelcache__vn_kqfilter = 0xfffffff007f42290,
    },
};
