...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.3.0: Wed Dec  7 19:48:59 PST 2022; root:xnu-8792.80.21.112.1~1/RELEASE_ARM64_T8101",
        ...
        .kernelcache__cdevsw = 0xfffffff00a4459c8,
        .kernelcache__gPhysBase = 0xfffffff00785c258,
        .kernelcache__gPhysSize = 0xfffffff00785c258 + 8,
        .kernelcache__gVirtBase = 0xfffffff00785a438,
        .kernelcache__perfmon_devices = 0xfffffff00a4815e0,
        .kernelcache__perfmon_dev_open = 0xfffffff007ef15a8,
        .kernelcache__ptov_table = 0xfffffff00780f478,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a480980,
        .kernelcache__vm_pages = 0xfffffff00780c190,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff00780e428,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a480978,
        .kernelcache__vn_kqfilter = 0xfffffff007f43b7c,
    },
};
