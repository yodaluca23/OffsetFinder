...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.3.0: Wed Dec  7 19:47:16 PST 2022; root:xnu-8792.80.21.112.1~1/RELEASE_ARM64_T8020",
        ...
        .kernelcache__cdevsw = 0xfffffff00a1759b0,
        ...
        .kernelcache__perfmon_devices = 0xfffffff00a1b15b0,
        .kernelcache__perfmon_dev_open = 0xfffffff007e547e4,
        .kernelcache__ptov_table = 0xfffffff0077bb348,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a1b0980,
        .kernelcache__vm_pages = 0xfffffff0077b8180,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0077ba308,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a1b0978,
        .kernelcache__vn_kqfilter = 0xfffffff007ea6e94,
    },
};
