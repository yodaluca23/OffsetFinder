...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a3759c0,
        .kernelcache__gPhysBase = 0xfffffff007854258,
        .kernelcache__gPhysSize = 0xfffffff007854258 + 8,
        .kernelcache__gVirtBase = 0xfffffff007852438,
        .kernelcache__perfmon_devices = 0xfffffff00a3b15e0,
        .kernelcache__perfmon_dev_open = 0xfffffff007ede0cc,
        .kernelcache__ptov_table = 0xfffffff0078074b0,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a3b0980,
        .kernelcache__vm_pages = 0xfffffff0078041d8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff007806470,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a3b0978,
        .kernelcache__vn_kqfilter = 0xfffffff007f2e0fc,
    },
};
