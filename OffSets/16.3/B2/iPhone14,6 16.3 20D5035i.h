...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.3.0: Wed Jan  4 21:39:03 PST 2023; root:xnu-8792.80.25.122.5~1/RELEASE_ARM64_T8110",
        ...
        .kernelcache__cdevsw = 0xfffffff00a3f59c0,
        .kernelcache__gPhysBase = 0xfffffff007868258,
        .kernelcache__gPhysSize = 0xfffffff007868258 + 8,
        .kernelcache__gVirtBase = 0xfffffff007866438,
        .kernelcache__perfmon_devices = 0xfffffff00a4315e0,
        .kernelcache__perfmon_dev_open = 0xfffffff007efe0cc,
        .kernelcache__ptov_table = 0xfffffff00781b4b0,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a430980,
        .kernelcache__vm_pages = 0xfffffff0078181d8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff00781a470,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a430978,
        .kernelcache__vn_kqfilter = 0xfffffff007f4e0fc,
    },
};
