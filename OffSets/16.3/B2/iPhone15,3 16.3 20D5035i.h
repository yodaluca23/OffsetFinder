...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.3.0: Wed Jan  4 21:39:26 PST 2023; root:xnu-8792.80.25.122.5~1/RELEASE_ARM64_T8120",
        ...
        .kernelcache__cdevsw = 0xfffffff00a3419c0,
        .kernelcache__gPhysBase = 0xfffffff007854168,
        .kernelcache__gPhysSize = 0xfffffff007854168 + 8,
        .kernelcache__gVirtBase = 0xfffffff007852348,
        .kernelcache__perfmon_devices = 0xfffffff00a37d5c0,
        .kernelcache__perfmon_dev_open = 0xfffffff007ed9fc0,
        .kernelcache__ptov_table = 0xfffffff007807510,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a37c980,
        .kernelcache__vm_pages = 0xfffffff0078041d0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0078064d0,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a37c978,
        .kernelcache__vn_kqfilter = 0xfffffff007f29ff0,
    },
};
