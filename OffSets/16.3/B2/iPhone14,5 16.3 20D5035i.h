...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a3919c0,
        .kernelcache__gPhysBase = 0xfffffff007858258,
        .kernelcache__gPhysSize = 0xfffffff007858258 + 8,
        .kernelcache__gVirtBase = 0xfffffff007856438,
        .kernelcache__perfmon_devices = 0xfffffff00a3cd5e0,
        .kernelcache__perfmon_dev_open = 0xfffffff007ee60cc,
        .kernelcache__ptov_table = 0xfffffff00780b4b0,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a3cc980,
        .kernelcache__vm_pages = 0xfffffff0078081d8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff00780a470,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a3cc978,
        .kernelcache__vn_kqfilter = 0xfffffff007f360fc,
    },
};
