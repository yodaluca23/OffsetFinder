...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.3.0: Wed Jan  4 21:39:02 PST 2023; root:xnu-8792.80.25.122.5~1/RELEASE_ARM64_T8020",
        ...
        .kernelcache__cdevsw = 0xfffffff00a2519a8,
        .kernelcache__gPhysBase = 0xfffffff00781bdf0,
        .kernelcache__gPhysSize = 0xfffffff00781bdf0 + 8,
        .kernelcache__gVirtBase = 0xfffffff007819fd0,
        .kernelcache__perfmon_devices = 0xfffffff00a28d5b0,
        .kernelcache__perfmon_dev_open = 0xfffffff007e88690,
        .kernelcache__ptov_table = 0xfffffff0077cf388,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a28c980,
        .kernelcache__vm_pages = 0xfffffff0077cc1c0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0077ce348,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a28c978,
        .kernelcache__vn_kqfilter = 0xfffffff007edad30,
    },
};
