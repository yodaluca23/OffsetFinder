...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.3.0: Wed Jan  4 21:39:04 PST 2023; root:xnu-8792.80.25.122.5~1/RELEASE_ARM64_T8101",
        ...
        .kernelcache__cdevsw = 0xfffffff00a3d59c0,
        .kernelcache__gPhysBase = 0xfffffff007850258,
        .kernelcache__gPhysSize = 0xfffffff007850258 + 8,
        .kernelcache__gVirtBase = 0xfffffff00784e438,
        .kernelcache__perfmon_devices = 0xfffffff00a4115e0,
        .kernelcache__perfmon_dev_open = 0xfffffff007ee5398,
        .kernelcache__ptov_table = 0xfffffff0078034b8,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a410980,
        .kernelcache__vm_pages = 0xfffffff0078001d0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff007802468,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a410978,
        .kernelcache__vn_kqfilter = 0xfffffff007f3795c,
    },
};
