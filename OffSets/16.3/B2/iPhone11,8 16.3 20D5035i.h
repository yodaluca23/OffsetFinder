...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a1119a8,
        .kernelcache__gPhysBase = 0xfffffff0077ffdf0,
        .kernelcache__gPhysSize = 0xfffffff0077ffdf0 + 8,
        .kernelcache__gVirtBase = 0xfffffff0077fdfd0,
        .kernelcache__perfmon_devices = 0xfffffff00a14d5b0,
        .kernelcache__perfmon_dev_open = 0xfffffff007e4c690,
        .kernelcache__ptov_table = 0xfffffff0077b3388,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a14c980,
        .kernelcache__vm_pages = 0xfffffff0077b01c0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0077b2348,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a14c978,
        .kernelcache__vn_kqfilter = 0xfffffff007e9ed30,
    },
};
