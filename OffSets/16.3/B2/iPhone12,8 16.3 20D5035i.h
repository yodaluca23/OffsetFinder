...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a32d9a8,
        .kernelcache__gPhysBase = 0xfffffff00785fd28,
        .kernelcache__gPhysSize = 0xfffffff00785fd28 + 8,
        .kernelcache__gVirtBase = 0xfffffff00785df08,
        .kernelcache__perfmon_devices = 0xfffffff00a3695a0,
        .kernelcache__perfmon_dev_open = 0xfffffff007ecdee0,
        .kernelcache__ptov_table = 0xfffffff0078133a0,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a368980,
        .kernelcache__vm_pages = 0xfffffff0078101c8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff007812350,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a368978,
        .kernelcache__vn_kqfilter = 0xfffffff007f20224,
    },
};
