...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a37d998,
        ...
        .kernelcache__perfmon_devices = 0xfffffff00a3b8120,
        .kernelcache__perfmon_dev_open = 0xfffffff007edb154,
        .kernelcache__ptov_table = 0xfffffff0077ffcb0,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a3b74b0,
        .kernelcache__vm_pages = 0xfffffff0077fc9d8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0077fec70,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a3b74a8,
        .kernelcache__vn_kqfilter = 0xfffffff007f2af94,
    },
};
