...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a1d9980,
        ...
        .kernelcache__perfmon_devices = 0xfffffff00a2140f0,
        .kernelcache__perfmon_dev_open = 0xfffffff007e69640,
        .kernelcache__ptov_table = 0xfffffff0077b7b88,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a2134b0,
        .kernelcache__vm_pages = 0xfffffff0077b49c0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0077b6b48,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a2134a8,
        .kernelcache__vn_kqfilter = 0xfffffff007ebbaa4,
    },
};
