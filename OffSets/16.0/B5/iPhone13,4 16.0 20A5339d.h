...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.0.0: Mon Aug  1 07:26:46 PDT 2022; root:xnu-8792.2.4~12/RELEASE_ARM64_T8101",
        ...
        .kernelcache__perfmon_devices = 0xfffffff00a390120,
        .kernelcache__perfmon_dev_open = 0xfffffff007ec22c8,
        .kernelcache__ptov_table = 0xfffffff0077e7cb8,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a38f4b0,
        .kernelcache__vm_pages = 0xfffffff0077e49d0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0077e6c68,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a38f4a8,
        .kernelcache__vn_kqfilter = 0xfffffff007f14674,
    },
};
