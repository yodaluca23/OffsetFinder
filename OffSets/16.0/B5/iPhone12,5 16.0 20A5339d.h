...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a2fd980,
        ...
        .kernelcache__perfmon_devices = 0xfffffff00a3380e0,
        .kernelcache__perfmon_dev_open = 0xfffffff007ec2e38,
        .kernelcache__ptov_table = 0xfffffff007807ba0,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a3374b0,
        .kernelcache__vm_pages = 0xfffffff0078049c8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff007806b50,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a3374a8,
        .kernelcache__vn_kqfilter = 0xfffffff007f14f64,
    },
};
