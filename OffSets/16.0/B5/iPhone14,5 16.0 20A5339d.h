...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.0.0: Mon Aug  1 07:26:11 PDT 2022; root:xnu-8792.2.4~12/RELEASE_ARM64_T8110",
        ...
        .kernelcache__cdevsw = 0xfffffff00a31d998,
        .kernelcache__gPhysBase = 0xfffffff00783be90,
        .kernelcache__gPhysSize = 0xfffffff00783be90 + 8,
        .kernelcache__gVirtBase = 0xfffffff00783a078,
        .kernelcache__perfmon_devices = 0xfffffff00a358120,
        .kernelcache__perfmon_dev_open = 0xfffffff007ec3154,
        .kernelcache__ptov_table = 0xfffffff0077efcb0,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a3574b0,
        .kernelcache__vm_pages = 0xfffffff0077ec9d8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0077eec70,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a3574a8,
        .kernelcache__vn_kqfilter = 0xfffffff007f12f94,
    },
};
