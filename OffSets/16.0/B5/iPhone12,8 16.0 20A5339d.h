...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.0.0: Mon Aug  1 07:26:09 PDT 2022; root:xnu-8792.2.4~12/RELEASE_ARM64_T8030",
        ...
        .kernelcache__cdevsw = 0xfffffff00a2b1980,
        ...
        .kernelcache__perfmon_devices = 0xfffffff00a2ec0e0,
        .kernelcache__perfmon_dev_open = 0xfffffff007eaae38,
        .kernelcache__ptov_table = 0xfffffff0077f7ba0,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a2eb4b0,
        .kernelcache__vm_pages = 0xfffffff0077f49c8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0077f6b50,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a2eb4a8,
        .kernelcache__vn_kqfilter = 0xfffffff007efcf64,
    },
};
