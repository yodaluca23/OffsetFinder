...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.0.0: Tue Jun 14 22:01:30 PDT 2022; root:xnu-8792.0.92.122.1~3/RELEASE_ARM64_T8030",
        ...
        .kernelcache__cdevsw = 0xfffffff00a4bd0b0,
        .kernelcache__gPhysBase = 0xfffffff009ef35b0,
        .kernelcache__gPhysSize = 0xfffffff009ef35b0 + 8,
        .kernelcache__gVirtBase = 0xfffffff009ef1798,
        .kernelcache__perfmon_devices = 0xfffffff00a4f59b0,
        .kernelcache__perfmon_dev_open = 0xfffffff007b68070,
        .kernelcache__ptov_table = 0xfffffff009ea7968,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a4f4e60,
        .kernelcache__vm_pages = 0xfffffff009ea47e0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff009ea6928,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a4f4e58,
        .kernelcache__vn_kqfilter = 0xfffffff007bba140,
    },
};
