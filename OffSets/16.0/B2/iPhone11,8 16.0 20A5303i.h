...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a2490b0,
        .kernelcache__gPhysBase = 0xfffffff009ccf688,
        .kernelcache__gPhysSize = 0xfffffff009ccf688 + 8,
        .kernelcache__gVirtBase = 0xfffffff009ccd870,
        .kernelcache__perfmon_devices = 0xfffffff00a2819c0,
        .kernelcache__perfmon_dev_open = 0xfffffff007af2f78,
        .kernelcache__ptov_table = 0xfffffff009c83960,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a280e60,
        .kernelcache__vm_pages = 0xfffffff009c807d8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff009c82920,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a280e58,
        .kernelcache__vn_kqfilter = 0xfffffff007b453c8,
    },
};
