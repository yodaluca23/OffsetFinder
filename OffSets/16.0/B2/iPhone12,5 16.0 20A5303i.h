...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a4c10b0,
        .kernelcache__gPhysBase = 0xfffffff009ef75b0,
        .kernelcache__gPhysSize = 0xfffffff009ef75b0 + 8,
        .kernelcache__gVirtBase = 0xfffffff009ef5798,
        .kernelcache__perfmon_devices = 0xfffffff00a4f99b0,
        .kernelcache__perfmon_dev_open = 0xfffffff007b68070,
        .kernelcache__ptov_table = 0xfffffff009eab968,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a4f8e60,
        .kernelcache__vm_pages = 0xfffffff009ea87e0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff009eaa928,
