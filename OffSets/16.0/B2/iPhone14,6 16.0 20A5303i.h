...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a5210d0,
        .kernelcache__gPhysBase = 0xfffffff009f27af8,
        .kernelcache__gPhysSize = 0xfffffff009f27af8 + 8,
        .kernelcache__gVirtBase = 0xfffffff009f25ce0,
        .kernelcache__perfmon_devices = 0xfffffff00a5599f0,
        .kernelcache__perfmon_dev_open = 0xfffffff007b47c6c,
        .kernelcache__ptov_table = 0xfffffff009edba90,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a558e60,
        .kernelcache__vm_pages = 0xfffffff009ed87f0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff009edaa50,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a558e58,
        .kernelcache__vn_kqfilter = 0xfffffff007b97a44,
    },
};
