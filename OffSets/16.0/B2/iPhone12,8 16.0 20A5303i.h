...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a4790b0,
        .kernelcache__gPhysBase = 0xfffffff009eb35b0,
        .kernelcache__gPhysSize = 0xfffffff009eb35b0 + 8,
        .kernelcache__gVirtBase = 0xfffffff009eb1798,
        .kernelcache__perfmon_devices = 0xfffffff00a4b19b0,
        .kernelcache__perfmon_dev_open = 0xfffffff007b58070,
        .kernelcache__ptov_table = 0xfffffff009e67968,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a4b0e60,
        .kernelcache__vm_pages = 0xfffffff009e647e0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff009e66928,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a4b0e58,
        .kernelcache__vn_kqfilter = 0xfffffff007baa140,
    },
};
