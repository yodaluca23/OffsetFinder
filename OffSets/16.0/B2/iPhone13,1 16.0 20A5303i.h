...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.0.0: Tue Jun 14 21:59:17 PDT 2022; root:xnu-8792.0.92.122.1~3/RELEASE_ARM64_T8101",
        ...
        .kernelcache__cdevsw = 0xfffffff00a5010d0,
        .kernelcache__gPhysBase = 0xfffffff009f17ae8,
        .kernelcache__gPhysSize = 0xfffffff009f17ae8 + 8,
        .kernelcache__gVirtBase = 0xfffffff009f15cd0,
        .kernelcache__perfmon_devices = 0xfffffff00a5399f0,
        .kernelcache__perfmon_dev_open = 0xfffffff007b3b374,
        .kernelcache__ptov_table = 0xfffffff009ecba88,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a538e60,
        .kernelcache__vm_pages = 0xfffffff009ec87e8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff009ecaa48,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a538e58,
        .kernelcache__vn_kqfilter = 0xfffffff007b8d6c4,
    },
};
