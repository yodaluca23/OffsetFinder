...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.0.0: Tue Jun 14 22:01:54 PDT 2022; root:xnu-8792.0.92.122.1~3/RELEASE_ARM64_T8110",
        ...
        .task__object_size = 0x650,
        .thread__task_threads__next = 0x390 - 0x18,
        .thread__task_threads__prev = 0x390 - 0x18 + 8,
        .thread__map = 0x390,
        .thread__thread_id = 0x430,
        .thread__object_size = 0x4d0,
        .uthread__object_size = 0xfffffffffffffb30,
        ...
        .kernelcache__cdevsw = 0xfffffff00a4c10d0,
        .kernelcache__gPhysBase = 0xfffffff009ed3af8,
        .kernelcache__gPhysSize = 0xfffffff009ed3af8 + 8,
        .kernelcache__gVirtBase = 0xfffffff009ed1ce0,
        .kernelcache__perfmon_devices = 0xfffffff00a4f99f0,
        .kernelcache__perfmon_dev_open = 0xfffffff007b37c6c,
        .kernelcache__ptov_table = 0xfffffff009e87a90,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a4f8e60,
        .kernelcache__vm_pages = 0xfffffff009e847f0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff009e86a50,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a4f8e58,
        .kernelcache__vn_kqfilter = 0xfffffff007b87a44,
    },
};
