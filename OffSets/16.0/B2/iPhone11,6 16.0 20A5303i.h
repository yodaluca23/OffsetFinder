...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.0.0: Tue Jun 14 22:01:44 PDT 2022; root:xnu-8792.0.92.122.1~3/RELEASE_ARM64_T8020",
        ...
        .thread__object_size = 0x4b0,
        .uthread__object_size = 0xfffffffffffffb50,
        ...
        .kernelcache__cdevsw = 0xfffffff00a3c90b0,
        .kernelcache__gPhysBase = 0xfffffff009e03688,
        .kernelcache__gPhysSize = 0xfffffff009e03688 + 8,
        .kernelcache__gVirtBase = 0xfffffff009e01870,
        .kernelcache__perfmon_devices = 0xfffffff00a4019c0,
        .kernelcache__perfmon_dev_open = 0xfffffff007b1af78,
        .kernelcache__ptov_table = 0xfffffff009db7960,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a400e60,
        .kernelcache__vm_pages = 0xfffffff009db47d8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff009db6920,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a400e58,
        .kernelcache__vn_kqfilter = 0xfffffff007b6d3c8,
    },
};
