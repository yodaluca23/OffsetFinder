...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.0.0: Fri Jun 24 18:24:36 PDT 2022; root:xnu-8792.0.134.0.1~6/RELEASE_ARM64_T8020",
        ...
        .kernelcache__cdevsw = 0xfffffff00a27d8f0,
        .kernelcache__gPhysBase = 0xfffffff007817870,
        .kernelcache__gPhysSize = 0xfffffff007817870 + 8,
        .kernelcache__gVirtBase = 0xfffffff007815a58,
        .kernelcache__perfmon_devices = 0xfffffff00a2b6cb0,
        .kernelcache__perfmon_dev_open = 0xfffffff007e7dab0,
        .kernelcache__ptov_table = 0xfffffff0077cba70,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a2b6060,
        .kernelcache__vm_pages = 0xfffffff0077c88e8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0077caa30,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a2b6058,
        .kernelcache__vn_kqfilter = 0xfffffff007ecff1c,
    },
};
