...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a3718f0,
        .kernelcache__gPhysBase = 0xfffffff007867798,
        .kernelcache__gPhysSize = 0xfffffff007867798 + 8,
        .kernelcache__gVirtBase = 0xfffffff007865980,
        .kernelcache__perfmon_devices = 0xfffffff00a3aaca0,
        .kernelcache__perfmon_dev_open = 0xfffffff007ed6ba4,
        .kernelcache__ptov_table = 0xfffffff00781ba78,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a3aa060,
        .kernelcache__vm_pages = 0xfffffff0078188f0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff00781aa38,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a3aa058,
        .kernelcache__vn_kqfilter = 0xfffffff007f28cd8,
    },
};
