...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a389908,
        .kernelcache__gPhysBase = 0xfffffff00784bce0,
        .kernelcache__gPhysSize = 0xfffffff00784bce0 + 8,
        .kernelcache__gVirtBase = 0xfffffff007849ec8,
        .kernelcache__perfmon_devices = 0xfffffff00a3c2ce0,
        .kernelcache__perfmon_dev_open = 0xfffffff007ecf374,
        .kernelcache__ptov_table = 0xfffffff0077ffba0,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a3c2060,
        .kernelcache__vm_pages = 0xfffffff0077fc900,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0077feb60,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a3c2058,
        .kernelcache__vn_kqfilter = 0xfffffff007f1f1bc,
    },
};
