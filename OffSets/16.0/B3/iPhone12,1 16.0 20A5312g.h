...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.0.0: Fri Jun 24 18:23:53 PDT 2022; root:xnu-8792.0.134.0.1~6/RELEASE_ARM64_T8030",
        ...
        .kernelcache__cdevsw = 0xfffffff00a3698f0,
        .kernelcache__gPhysBase = 0xfffffff007863798,
        .kernelcache__gPhysSize = 0xfffffff007863798 + 8,
        .kernelcache__gVirtBase = 0xfffffff007861980,
        .kernelcache__perfmon_devices = 0xfffffff00a3a2ca0,
        .kernelcache__perfmon_dev_open = 0xfffffff007ed2ba4,
        .kernelcache__ptov_table = 0xfffffff007817a78,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a3a2060,
        .kernelcache__vm_pages = 0xfffffff0078148f0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff007816a38,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a3a2058,
        .kernelcache__vn_kqfilter = 0xfffffff007f24cd8,
    },
};
