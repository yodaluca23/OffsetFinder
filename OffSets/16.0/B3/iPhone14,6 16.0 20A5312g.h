...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.0.0: Fri Jun 24 18:23:40 PDT 2022; root:xnu-8792.0.134.0.1~6/RELEASE_ARM64_T8110",
        ...
        .kernelcache__cdevsw = 0xfffffff00a3e5908,
        .kernelcache__gPhysBase = 0xfffffff007857ce0,
        .kernelcache__gPhysSize = 0xfffffff007857ce0 + 8,
        .kernelcache__gVirtBase = 0xfffffff007855ec8,
        .kernelcache__perfmon_devices = 0xfffffff00a41ece0,
        .kernelcache__perfmon_dev_open = 0xfffffff007ee3374,
        .kernelcache__ptov_table = 0xfffffff00780bba0,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a41e060,
        .kernelcache__vm_pages = 0xfffffff007808900,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff00780ab60,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a41e058,
        .kernelcache__vn_kqfilter = 0xfffffff007f331bc,
    },
};
