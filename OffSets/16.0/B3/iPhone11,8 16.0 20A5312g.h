...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a0fd8f0,
        .kernelcache__gPhysBase = 0xfffffff0077ef870,
        .kernelcache__gPhysSize = 0xfffffff0077ef870 + 8,
        .kernelcache__gVirtBase = 0xfffffff0077eda58,
        .kernelcache__perfmon_devices = 0xfffffff00a136cb0,
        .kernelcache__perfmon_dev_open = 0xfffffff007e35ab0,
        .kernelcache__ptov_table = 0xfffffff0077a3a70,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a136060,
        .kernelcache__vm_pages = 0xfffffff0077a08e8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0077a2a30,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a136058,
        .kernelcache__vn_kqfilter = 0xfffffff007e87f1c,
    },
};
