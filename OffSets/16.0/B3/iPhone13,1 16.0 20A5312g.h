...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.0.0: Fri Jun 24 18:24:25 PDT 2022; root:xnu-8792.0.134.0.1~6/RELEASE_ARM64_T8101",
        ...
        .kernelcache__cdevsw = 0xfffffff00a3c1908,
        .kernelcache__gPhysBase = 0xfffffff007843cd0,
        .kernelcache__gPhysSize = 0xfffffff007843cd0 + 8,
        .kernelcache__gVirtBase = 0xfffffff007841eb8,
        .kernelcache__perfmon_devices = 0xfffffff00a3face0,
        .kernelcache__perfmon_dev_open = 0xfffffff007ecddb8,
        .kernelcache__ptov_table = 0xfffffff0077f7b98,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a3fa060,
        .kernelcache__vm_pages = 0xfffffff0077f48f8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0077f6b58,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a3fa058,
        .kernelcache__vn_kqfilter = 0xfffffff007f2016c,
    },
};
