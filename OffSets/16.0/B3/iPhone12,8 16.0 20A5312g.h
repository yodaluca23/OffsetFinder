...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a3218f0,
        .kernelcache__gPhysBase = 0xfffffff007853798,
        .kernelcache__gPhysSize = 0xfffffff007853798 + 8,
        .kernelcache__gVirtBase = 0xfffffff007851980,
        .kernelcache__perfmon_devices = 0xfffffff00a35aca0,
        .kernelcache__perfmon_dev_open = 0xfffffff007ebaba4,
        .kernelcache__ptov_table = 0xfffffff007807a78,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a35a060,
        .kernelcache__vm_pages = 0xfffffff0078048f0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff007806a38,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a35a058,
        .kernelcache__vn_kqfilter = 0xfffffff007f0ccd8,
    },
};
