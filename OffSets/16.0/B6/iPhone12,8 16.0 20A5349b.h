...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a2b9980,
        .kernelcache__gPhysBase = 0xfffffff007843960,
        .kernelcache__gPhysSize = 0xfffffff007843960 + 8,
        .kernelcache__gVirtBase = 0xfffffff007841b48,
        .kernelcache__perfmon_devices = 0xfffffff00a2f40e0,
        .kernelcache__perfmon_dev_open = 0xfffffff007eaefbc,
        .kernelcache__ptov_table = 0xfffffff0077f7ba0,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a2f34b0,
        .kernelcache__vm_pages = 0xfffffff0077f49c8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0077f6b50,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a2f34a8,
        .kernelcache__vn_kqfilter = 0xfffffff007f010e8,
    },
};
