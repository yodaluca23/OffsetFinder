...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a301980,
        .kernelcache__gPhysBase = 0xfffffff007853960,
        .kernelcache__gPhysSize = 0xfffffff007853960 + 8,
        .kernelcache__gVirtBase = 0xfffffff007851b48,
        .kernelcache__perfmon_devices = 0xfffffff00a33c0e0,
        .kernelcache__perfmon_dev_open = 0xfffffff007ec6fbc,
        .kernelcache__ptov_table = 0xfffffff007807ba0,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a33b4b0,
        .kernelcache__vm_pages = 0xfffffff0078049c8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff007806b50,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a33b4a8,
        .kernelcache__vn_kqfilter = 0xfffffff007f190e8,
    },
};
