...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.0.0: Wed Aug 10 23:37:39 PDT 2022; root:xnu-8792.12.6.162.2~2/RELEASE_ARM64_T8110",
        ...
        .kernelcache__cdevsw = 0xfffffff00a325998,
        .kernelcache__gPhysBase = 0xfffffff00783fe90,
        .kernelcache__gPhysSize = 0xfffffff00783fe90 + 8,
        .kernelcache__gVirtBase = 0xfffffff00783e078,
        .kernelcache__perfmon_devices = 0xfffffff00a360120,
        .kernelcache__perfmon_dev_open = 0xfffffff007ec7208,
        .kernelcache__ptov_table = 0xfffffff0077f3cb0,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a35f4b0,
        .kernelcache__vm_pages = 0xfffffff0077f09d8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0077f2c70,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a35f4a8,
        .kernelcache__vn_kqfilter = 0xfffffff007f17048,
    },
};
