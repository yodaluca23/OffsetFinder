...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a09d980,
        .kernelcache__gPhysBase = 0xfffffff0077e3a28,
        .kernelcache__gPhysSize = 0xfffffff0077e3a28 + 8,
        .kernelcache__gVirtBase = 0xfffffff0077e1c10,
        .kernelcache__perfmon_devices = 0xfffffff00a0d80f0,
        .kernelcache__perfmon_dev_open = 0xfffffff007e297c4,
        .kernelcache__ptov_table = 0xfffffff007797b88,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a0d74b0,
        .kernelcache__vm_pages = 0xfffffff0077949c0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff007796b48,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a0d74a8,
        .kernelcache__vn_kqfilter = 0xfffffff007e7bc28,
    },
};
