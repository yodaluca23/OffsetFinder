...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.0.0: Wed Aug 10 23:36:45 PDT 2022; root:xnu-8792.12.6.162.2~2/RELEASE_ARM64_T8101",
        ...
        .kernelcache__cdevsw = 0xfffffff00a359998,
        .kernelcache__gPhysBase = 0xfffffff007833e90,
        .kernelcache__gPhysSize = 0xfffffff007833e90 + 8,
        .kernelcache__gVirtBase = 0xfffffff007832078,
        .kernelcache__perfmon_devices = 0xfffffff00a394120,
        .kernelcache__perfmon_dev_open = 0xfffffff007ec2458,
        .kernelcache__ptov_table = 0xfffffff0077e7cb8,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a3934b0,
        .kernelcache__vm_pages = 0xfffffff0077e49d0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0077e6c68,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a3934a8,
        .kernelcache__vn_kqfilter = 0xfffffff007f14804,
    },
};
