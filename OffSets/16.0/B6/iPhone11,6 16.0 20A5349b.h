...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.0.0: Wed Aug 10 23:37:34 PDT 2022; root:xnu-8792.12.6.162.2~2/RELEASE_ARM64_T8020",
        ...
        .kernelcache__cdevsw = 0xfffffff00a1dd980,
        .kernelcache__gPhysBase = 0xfffffff007803a28,
        .kernelcache__gPhysSize = 0xfffffff007803a28 + 8,
        .kernelcache__gVirtBase = 0xfffffff007801c10,
        .kernelcache__perfmon_devices = 0xfffffff00a2180f0,
        .kernelcache__perfmon_dev_open = 0xfffffff007e697c4,
        .kernelcache__ptov_table = 0xfffffff0077b7b88,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a2174b0,
        .kernelcache__vm_pages = 0xfffffff0077b49c0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0077b6b48,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a2174a8,
        .kernelcache__vn_kqfilter = 0xfffffff007ebbc28,
    },
};
