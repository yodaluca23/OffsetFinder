...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.0.0: Wed Aug 10 23:37:39 PDT 2022; root:xnu-8792.12.6.162.2~2/RELEASE_ARM64_T8030",
        ...
        .kernelcache__cdevsw = 0xfffffff00a309980,
        .kernelcache__gPhysBase = 0xfffffff007857960,
        .kernelcache__gPhysSize = 0xfffffff007857960 + 8,
        .kernelcache__gVirtBase = 0xfffffff007855b48,
        .kernelcache__perfmon_devices = 0xfffffff00a3440e0,
        .kernelcache__perfmon_dev_open = 0xfffffff007ecafbc,
        .kernelcache__ptov_table = 0xfffffff00780bba0,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a3434b0,
        .kernelcache__vm_pages = 0xfffffff0078089c8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff00780ab50,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a3434a8,
        .kernelcache__vn_kqfilter = 0xfffffff007f1d0e8,
    },
};
