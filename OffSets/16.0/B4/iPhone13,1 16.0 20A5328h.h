...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.0.0: Tue Jul 19 02:35:56 PDT 2022; root:xnu-8792.0.188.142.2~2/RELEASE_ARM64_T8101",
        ...
        .kernelcache__cdevsw = 0xfffffff00a361908,
        .kernelcache__gPhysBase = 0xfffffff007837e40,
        .kernelcache__gPhysSize = 0xfffffff007837e40 + 8,
        .kernelcache__gVirtBase = 0xfffffff007836028,
        .kernelcache__perfmon_devices = 0xfffffff00a39ace0,
        .kernelcache__perfmon_dev_open = 0xfffffff007ec2a6c,
        .kernelcache__ptov_table = 0xfffffff0077ebbb8,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a39a060,
        .kernelcache__vm_pages = 0xfffffff0077e88f0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0077eab78,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a39a058,
        .kernelcache__vn_kqfilter = 0xfffffff007f14dec,
    },
};
