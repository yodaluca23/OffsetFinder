...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a1e98f0,
        .kernelcache__gPhysBase = 0xfffffff0078039e0,
        .kernelcache__gPhysSize = 0xfffffff0078039e0 + 8,
        .kernelcache__gVirtBase = 0xfffffff007801bc8,
        .kernelcache__perfmon_devices = 0xfffffff00a222cb0,
        .kernelcache__perfmon_dev_open = 0xfffffff007e6a758,
        .kernelcache__ptov_table = 0xfffffff0077b7a98,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a222060,
        .kernelcache__vm_pages = 0xfffffff0077b48e0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0077b6a58,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a222058,
        .kernelcache__vn_kqfilter = 0xfffffff007ebcb90,
    },
};
