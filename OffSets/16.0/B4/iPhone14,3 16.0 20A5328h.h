...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a329908,
        .kernelcache__gPhysBase = 0xfffffff00783fe50,
        .kernelcache__gPhysSize = 0xfffffff00783fe50 + 8,
        .kernelcache__gVirtBase = 0xfffffff00783e038,
        .kernelcache__perfmon_devices = 0xfffffff00a362ce0,
        .kernelcache__perfmon_dev_open = 0xfffffff007ec8068,
        .kernelcache__ptov_table = 0xfffffff0077f3bc0,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a362060,
        .kernelcache__vm_pages = 0xfffffff0077f08f8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0077f2b80,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a362058,
        .kernelcache__vn_kqfilter = 0xfffffff007f17e7c,
    },
};
