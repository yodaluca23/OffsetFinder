...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.0.0: Tue Jul 19 02:35:53 PDT 2022; root:xnu-8792.0.188.142.2~2/RELEASE_ARM64_T8030",
        ...
        .kernelcache__cdevsw = 0xfffffff00a3098f0,
        .kernelcache__gPhysBase = 0xfffffff007857908,
        .kernelcache__gPhysSize = 0xfffffff007857908 + 8,
        .kernelcache__gVirtBase = 0xfffffff007855af0,
        .kernelcache__perfmon_devices = 0xfffffff00a342ca0,
        .kernelcache__perfmon_dev_open = 0xfffffff007ec785c,
        .kernelcache__ptov_table = 0xfffffff00780baa0,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a342060,
        .kernelcache__vm_pages = 0xfffffff0078088e8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff00780aa60,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a342058,
        .kernelcache__vn_kqfilter = 0xfffffff007f1995c,
    },
};
