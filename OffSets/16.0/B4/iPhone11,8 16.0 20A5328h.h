...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.0.0: Tue Jul 19 02:36:05 PDT 2022; root:xnu-8792.0.188.142.2~2/RELEASE_ARM64_T8020",
        ...
        .thread__task_threads__next = 0x370 - 0x18,
        .thread__task_threads__prev = 0x370 - 0x18 + 8,
        .thread__map = 0x370,
        .thread__thread_id = 0x408,
        ...
        .kernelcache__cdevsw = 0xfffffff00a0ad8f0,
        .kernelcache__gPhysBase = 0xfffffff0077e79e0,
        .kernelcache__gPhysSize = 0xfffffff0077e79e0 + 8,
        .kernelcache__gVirtBase = 0xfffffff0077e5bc8,
        .kernelcache__perfmon_devices = 0xfffffff00a0e6cb0,
        .kernelcache__perfmon_dev_open = 0xfffffff007e2e758,
        .kernelcache__ptov_table = 0xfffffff00779ba98,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a0e6060,
        .kernelcache__vm_pages = 0xfffffff0077988e0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff00779aa58,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a0e6058,
        .kernelcache__vn_kqfilter = 0xfffffff007e80b90,
    },
};
