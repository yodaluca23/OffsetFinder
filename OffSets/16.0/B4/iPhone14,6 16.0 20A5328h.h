...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.0.0: Tue Jul 19 02:35:56 PDT 2022; root:xnu-8792.0.188.142.2~2/RELEASE_ARM64_T8110",
        ...
        .thread__task_threads__next = 0x388 - 0x18,
        .thread__task_threads__prev = 0x388 - 0x18 + 8,
        .thread__map = 0x388,
        .thread__thread_id = 0x428,
        ...
        .kernelcache__gPhysBase = 0xfffffff00784fe50,
        .kernelcache__gPhysSize = 0xfffffff00784fe50 + 8,
        .kernelcache__gVirtBase = 0xfffffff00784e038,
        .kernelcache__perfmon_devices = 0xfffffff00a3c2ce0,
        .kernelcache__perfmon_dev_open = 0xfffffff007ee0068,
        .kernelcache__ptov_table = 0xfffffff007803bc0,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a3c2060,
        .kernelcache__vm_pages = 0xfffffff0078008f8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff007802b80,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a3c2058,
        .kernelcache__vn_kqfilter = 0xfffffff007f2fe7c,
    },
};
