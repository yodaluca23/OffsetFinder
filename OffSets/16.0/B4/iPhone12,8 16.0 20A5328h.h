...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a2c98f0,
        .kernelcache__gPhysBase = 0xfffffff007847908,
        .kernelcache__gPhysSize = 0xfffffff007847908 + 8,
        .kernelcache__gVirtBase = 0xfffffff007845af0,
        .kernelcache__perfmon_devices = 0xfffffff00a302ca0,
        .kernelcache__perfmon_dev_open = 0xfffffff007eb385c,
        .kernelcache__ptov_table = 0xfffffff0077fbaa0,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a302060,
        .kernelcache__vm_pages = 0xfffffff0077f88e8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0077faa60,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a302058,
        .kernelcache__vn_kqfilter = 0xfffffff007f0595c,
    },
};
