...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a355998,
        .kernelcache__gPhysBase = 0xfffffff007847fd0,
        .kernelcache__gPhysSize = 0xfffffff007847fd0 + 8,
        .kernelcache__gVirtBase = 0xfffffff0078461b8,
        .kernelcache__perfmon_devices = 0xfffffff00a391560,
        .kernelcache__perfmon_dev_open = 0xfffffff007ed4efc,
        .kernelcache__ptov_table = 0xfffffff0077fbab8,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a390900,
        .kernelcache__vm_pages = 0xfffffff0077f87e0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0077faa78,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a3908f8,
        .kernelcache__vn_kqfilter = 0xfffffff007f24e2c,
    },
};
