...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.1.0: Thu Sep 22 21:47:21 PDT 2022; root:xnu-8792.40.108.152.2~1/RELEASE_ARM64_T8110",
        ...
        .kernelcache__cdevsw = 0xfffffff00a3b5998,
        .kernelcache__gPhysBase = 0xfffffff007857fd0,
        .kernelcache__gPhysSize = 0xfffffff007857fd0 + 8,
        .kernelcache__gVirtBase = 0xfffffff0078561b8,
        .kernelcache__perfmon_devices = 0xfffffff00a3f1560,
        .kernelcache__perfmon_dev_open = 0xfffffff007eecefc,
        .kernelcache__ptov_table = 0xfffffff00780bab8,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a3f0900,
        .kernelcache__vm_pages = 0xfffffff0078087e0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff00780aa78,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a3f08f8,
        .kernelcache__vn_kqfilter = 0xfffffff007f3ce2c,
    },
};
