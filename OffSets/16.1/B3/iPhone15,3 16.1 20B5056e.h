...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.1.0: Thu Sep 22 21:45:53 PDT 2022; root:xnu-8792.40.108.152.2~1/RELEASE_ARM64_T8120",
        ...
        .kernelcache__cdevsw = 0xfffffff00a2fd998,
        .kernelcache__gPhysBase = 0xfffffff007843ee0,
        .kernelcache__gPhysSize = 0xfffffff007843ee0 + 8,
        .kernelcache__gVirtBase = 0xfffffff0078420c8,
        .kernelcache__perfmon_devices = 0xfffffff00a339540,
        .kernelcache__perfmon_dev_open = 0xfffffff007ec8dd0,
        .kernelcache__ptov_table = 0xfffffff0077f7b18,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a338900,
        .kernelcache__vm_pages = 0xfffffff0077f47d8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0077f6ad8,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a3388f8,
        .kernelcache__vn_kqfilter = 0xfffffff007f18d00,
    },
};
