...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.1.0: Thu Sep 22 21:47:12 PDT 2022; root:xnu-8792.40.108.152.2~1/RELEASE_ARM64_T8020",
        ...
        .kernelcache__cdevsw = 0xfffffff00a211980,
        .kernelcache__gPhysBase = 0xfffffff00780bb68,
        .kernelcache__gPhysSize = 0xfffffff00780bb68 + 8,
        .kernelcache__gVirtBase = 0xfffffff007809d50,
        .kernelcache__perfmon_devices = 0xfffffff00a24d530,
        .kernelcache__perfmon_dev_open = 0xfffffff007e73284,
        .kernelcache__ptov_table = 0xfffffff0077bf990,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a24c900,
        .kernelcache__vm_pages = 0xfffffff0077bc7c8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0077be950,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a24c8f8,
        .kernelcache__vn_kqfilter = 0xfffffff007ec5800,
    },
};
