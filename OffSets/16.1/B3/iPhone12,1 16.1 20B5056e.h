...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a331980,
        ...
        .kernelcache__perfmon_devices = 0xfffffff00a36d520,
        .kernelcache__perfmon_dev_open = 0xfffffff007ed0a94,
        .kernelcache__ptov_table = 0xfffffff0078139a8,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a36c900,
        .kernelcache__vm_pages = 0xfffffff0078107d0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff007812958,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a36c8f8,
        .kernelcache__vn_kqfilter = 0xfffffff007f22cd8,
    },
};
