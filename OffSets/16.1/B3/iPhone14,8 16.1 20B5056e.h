...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a335998,
        .kernelcache__gPhysBase = 0xfffffff007843fd0,
        .kernelcache__gPhysSize = 0xfffffff007843fd0 + 8,
        .kernelcache__gVirtBase = 0xfffffff0078421b8,
        .kernelcache__perfmon_devices = 0xfffffff00a371560,
        .kernelcache__perfmon_dev_open = 0xfffffff007ec8efc,
        .kernelcache__ptov_table = 0xfffffff0077f7ab8,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a370900,
        .kernelcache__vm_pages = 0xfffffff0077f47e0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0077f6a78,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a3708f8,
        .kernelcache__vn_kqfilter = 0xfffffff007f18e2c,
    },
};
