...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a0d1980,
        .kernelcache__gPhysBase = 0xfffffff0077efb68,
        .kernelcache__gPhysSize = 0xfffffff0077efb68 + 8,
        .kernelcache__gVirtBase = 0xfffffff0077edd50,
        .kernelcache__perfmon_devices = 0xfffffff00a10d530,
        .kernelcache__perfmon_dev_open = 0xfffffff007e3b284,
        .kernelcache__ptov_table = 0xfffffff0077a3990,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a10c900,
        .kernelcache__vm_pages = 0xfffffff0077a07c8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0077a2950,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a10c8f8,
        .kernelcache__vn_kqfilter = 0xfffffff007e8d800,
    },
};
