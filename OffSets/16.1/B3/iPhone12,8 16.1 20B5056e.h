...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a2ed980,
        .kernelcache__gPhysBase = 0xfffffff00784faa0,
        .kernelcache__gPhysSize = 0xfffffff00784faa0 + 8,
        .kernelcache__gVirtBase = 0xfffffff00784dc88,
        .kernelcache__perfmon_devices = 0xfffffff00a329520,
        .kernelcache__perfmon_dev_open = 0xfffffff007ebca94,
        .kernelcache__ptov_table = 0xfffffff0078039a8,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a328900,
        .kernelcache__vm_pages = 0xfffffff0078007d0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff007802958,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a3288f8,
        .kernelcache__vn_kqfilter = 0xfffffff007f0ecd8,
    },
};
