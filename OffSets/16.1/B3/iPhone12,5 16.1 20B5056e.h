...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.1.0: Thu Sep 22 21:47:20 PDT 2022; root:xnu-8792.40.108.152.2~1/RELEASE_ARM64_T8030",
        ...
        .kernelcache__cdevsw = 0xfffffff00a339980,
        .kernelcache__gPhysBase = 0xfffffff00785faa0,
        .kernelcache__gPhysSize = 0xfffffff00785faa0 + 8,
        .kernelcache__gVirtBase = 0xfffffff00785dc88,
        .kernelcache__perfmon_devices = 0xfffffff00a375520,
        .kernelcache__perfmon_dev_open = 0xfffffff007ed4a94,
        .kernelcache__ptov_table = 0xfffffff0078139a8,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a374900,
        .kernelcache__vm_pages = 0xfffffff0078107d0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff007812958,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a3748f8,
        .kernelcache__vn_kqfilter = 0xfffffff007f26cd8,
    },
};
