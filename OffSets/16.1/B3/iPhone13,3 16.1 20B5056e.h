...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.1.0: Thu Sep 22 21:47:21 PDT 2022; root:xnu-8792.40.108.152.2~1/RELEASE_ARM64_T8101",
        ...
        .kernelcache__cdevsw = 0xfffffff00a38d998,
        .kernelcache__gPhysBase = 0xfffffff00783ffd0,
        .kernelcache__gPhysSize = 0xfffffff00783ffd0 + 8,
        .kernelcache__gVirtBase = 0xfffffff00783e1b8,
        .kernelcache__perfmon_devices = 0xfffffff00a3c9560,
        .kernelcache__perfmon_dev_open = 0xfffffff007ed4050,
        .kernelcache__ptov_table = 0xfffffff0077f3ac0,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a3c8900,
        .kernelcache__vm_pages = 0xfffffff0077f07d8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0077f2a70,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a3c88f8,
        .kernelcache__vn_kqfilter = 0xfffffff007f26514,
    },
};
