...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.1.0: Sun Sep 11 23:03:57 PDT 2022; root:xnu-8792.40.101.0.1~17/RELEASE_ARM64_T8020",
        ...
        .kernelcache__cdevsw = 0xfffffff00a131980,
        .kernelcache__gPhysBase = 0xfffffff0077f7b68,
        .kernelcache__gPhysSize = 0xfffffff0077f7b68 + 8,
        .kernelcache__gVirtBase = 0xfffffff0077f5d50,
        .kernelcache__perfmon_devices = 0xfffffff00a16d530,
        .kernelcache__perfmon_dev_open = 0xfffffff007e42a4c,
        .kernelcache__ptov_table = 0xfffffff0077ab990,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a16c900,
        .kernelcache__vm_pages = 0xfffffff0077a87c8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0077aa950,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a16c8f8,
        .kernelcache__vn_kqfilter = 0xfffffff007e94fc0,
    },
};
