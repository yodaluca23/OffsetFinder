...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a421998,
        .kernelcache__gPhysBase = 0xfffffff007863fd0,
        .kernelcache__gPhysSize = 0xfffffff007863fd0 + 8,
        .kernelcache__gVirtBase = 0xfffffff0078621b8,
        .kernelcache__perfmon_devices = 0xfffffff00a45d560,
        .kernelcache__perfmon_dev_open = 0xfffffff007ef86e0,
        .kernelcache__ptov_table = 0xfffffff007817ab8,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a45c900,
        .kernelcache__vm_pages = 0xfffffff0078147e0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff007816a78,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a45c8f8,
        .kernelcache__vn_kqfilter = 0xfffffff007f48608,
    },
};
