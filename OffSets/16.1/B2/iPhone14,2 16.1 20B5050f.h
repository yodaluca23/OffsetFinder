...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a3c1998,
        .kernelcache__gPhysBase = 0xfffffff007853fd0,
        .kernelcache__gPhysSize = 0xfffffff007853fd0 + 8,
        .kernelcache__gVirtBase = 0xfffffff0078521b8,
        .kernelcache__perfmon_devices = 0xfffffff00a3fd560,
        .kernelcache__perfmon_dev_open = 0xfffffff007ee06e0,
        .kernelcache__ptov_table = 0xfffffff007807ab8,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a3fc900,
        .kernelcache__vm_pages = 0xfffffff0078047e0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff007806a78,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a3fc8f8,
        .kernelcache__vn_kqfilter = 0xfffffff007f30608,
    },
};
