...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.1.0: Sun Sep 11 23:03:57 PDT 2022; root:xnu-8792.40.101.0.1~17/RELEASE_ARM64_T8110",
        ...
        .kernelcache__cdevsw = 0xfffffff00a3a5998,
        .kernelcache__gPhysBase = 0xfffffff00784ffd0,
        .kernelcache__gPhysSize = 0xfffffff00784ffd0 + 8,
        .kernelcache__gVirtBase = 0xfffffff00784e1b8,
        .kernelcache__perfmon_devices = 0xfffffff00a3e1560,
        .kernelcache__perfmon_dev_open = 0xfffffff007ed86e0,
        .kernelcache__ptov_table = 0xfffffff007803ab8,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a3e0900,
        .kernelcache__vm_pages = 0xfffffff0078007e0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff007802a78,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a3e08f8,
        .kernelcache__vn_kqfilter = 0xfffffff007f28608,
    },
};
