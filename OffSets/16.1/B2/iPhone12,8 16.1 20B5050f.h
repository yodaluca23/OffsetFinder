...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a35d980,
        ...
        .kernelcache__perfmon_devices = 0xfffffff00a399520,
        .kernelcache__perfmon_dev_open = 0xfffffff007ecc25c,
        .kernelcache__ptov_table = 0xfffffff0078139a8,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a398900,
        .kernelcache__vm_pages = 0xfffffff0078107d0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff007812958,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a3988f8,
        .kernelcache__vn_kqfilter = 0xfffffff007f1e498,
    },
};
