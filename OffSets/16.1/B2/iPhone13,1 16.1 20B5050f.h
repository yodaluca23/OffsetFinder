...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.1.0: Sun Sep 11 23:03:32 PDT 2022; root:xnu-8792.40.101.0.1~17/RELEASE_ARM64_T8101",
        ...
        .kernelcache__cdevsw = 0xfffffff00a405998,
        .kernelcache__gPhysBase = 0xfffffff00784bfd0,
        .kernelcache__gPhysSize = 0xfffffff00784bfd0 + 8,
        .kernelcache__gVirtBase = 0xfffffff00784a1b8,
        .kernelcache__perfmon_devices = 0xfffffff00a441560,
        .kernelcache__perfmon_dev_open = 0xfffffff007edf810,
        .kernelcache__ptov_table = 0xfffffff0077ffac0,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a440900,
        .kernelcache__vm_pages = 0xfffffff0077fc7d8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0077fea70,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a4408f8,
        .kernelcache__vn_kqfilter = 0xfffffff007f31ccc,
    },
};
