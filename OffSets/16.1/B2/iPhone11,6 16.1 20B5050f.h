...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a2b5980,
        .kernelcache__gPhysBase = 0xfffffff00781fb68,
        .kernelcache__gPhysSize = 0xfffffff00781fb68 + 8,
        .kernelcache__gVirtBase = 0xfffffff00781dd50,
        .kernelcache__perfmon_devices = 0xfffffff00a2f1530,
        .kernelcache__perfmon_dev_open = 0xfffffff007e8aa4c,
        .kernelcache__ptov_table = 0xfffffff0077d3990,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a2f0900,
        .kernelcache__vm_pages = 0xfffffff0077d07c8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0077d2950,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a2f08f8,
        .kernelcache__vn_kqfilter = 0xfffffff007edcfc0,
    },
};
