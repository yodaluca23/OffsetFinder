...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.1.0: Sun Sep 11 23:03:55 PDT 2022; root:xnu-8792.40.101.0.1~17/RELEASE_ARM64_T8030",
        ...
        .kernelcache__cdevsw = 0xfffffff00a3a9980,
        .kernelcache__gPhysBase = 0xfffffff00786faa0,
        .kernelcache__gPhysSize = 0xfffffff00786faa0 + 8,
        .kernelcache__gVirtBase = 0xfffffff00786dc88,
        .kernelcache__perfmon_devices = 0xfffffff00a3e5520,
        .kernelcache__perfmon_dev_open = 0xfffffff007ee425c,
        .kernelcache__ptov_table = 0xfffffff0078239a8,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a3e4900,
        .kernelcache__vm_pages = 0xfffffff0078207d0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff007822958,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a3e48f8,
        .kernelcache__vn_kqfilter = 0xfffffff007f36498,
    },
};
