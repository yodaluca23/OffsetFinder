...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a215980,
        .kernelcache__gPhysBase = 0xfffffff00780fb68,
        .kernelcache__gPhysSize = 0xfffffff00780fb68 + 8,
        .kernelcache__gVirtBase = 0xfffffff00780dd50,
        .kernelcache__perfmon_devices = 0xfffffff00a251530,
        .kernelcache__perfmon_dev_open = 0xfffffff007e77c18,
        .kernelcache__ptov_table = 0xfffffff0077c3990,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a250900,
        .kernelcache__vm_pages = 0xfffffff0077c07c8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0077c2950,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a2508f8,
        .kernelcache__vn_kqfilter = 0xfffffff007eca194,
    },
};
