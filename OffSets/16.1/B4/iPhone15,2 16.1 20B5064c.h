...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.1.0: Mon Sep 26 21:51:13 PDT 2022; root:xnu-8792.42.5~5/RELEASE_ARM64_T8120",
        ...
        .kernelcache__cdevsw = 0xfffffff00a301998,
        ...
        .kernelcache__perfmon_devices = 0xfffffff00a33d540,
        .kernelcache__perfmon_dev_open = 0xfffffff007ec9574,
        .kernelcache__ptov_table = 0xfffffff0077f7b18,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a33c900,
        .kernelcache__vm_pages = 0xfffffff0077f47d8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0077f6ad8,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a33c8f8,
        .kernelcache__vn_kqfilter = 0xfffffff007f194a4,
    },
};
