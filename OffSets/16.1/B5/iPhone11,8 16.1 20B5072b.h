...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.1.0: Thu Oct  6 20:55:10 PDT 2022; root:xnu-8792.42.7~2/RELEASE_ARM64_T8020",
        ...
        .kernelcache__cdevsw = 0xfffffff00a0d5980,
        ...
        .kernelcache__perfmon_devices = 0xfffffff00a111530,
        .kernelcache__perfmon_dev_open = 0xfffffff007e3bc2c,
        .kernelcache__ptov_table = 0xfffffff0077a3990,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a110900,
        .kernelcache__vm_pages = 0xfffffff0077a07c8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0077a2950,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a1108f8,
        .kernelcache__vn_kqfilter = 0xfffffff007e8e1a8,
    },
};
