...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.1.0: Sun Sep  4 20:45:07 PDT 2022; root:xnu-8792.40.93~10/RELEASE_ARM64_T8101",
        ...
        .kernelcache__cdevsw = 0xfffffff00a3f9998,
        ...
        .kernelcache__perfmon_devices = 0xfffffff00a434120,
        .kernelcache__perfmon_dev_open = 0xfffffff007edb1ac,
        .kernelcache__ptov_table = 0xfffffff0077fbcc0,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a4334b0,
        .kernelcache__vm_pages = 0xfffffff0077f89d8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0077fac70,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a4334a8,
        .kernelcache__vn_kqfilter = 0xfffffff007f2d668,
    },
};
