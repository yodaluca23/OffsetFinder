...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a129980,
        ...
        .kernelcache__perfmon_devices = 0xfffffff00a1640f0,
        .kernelcache__perfmon_dev_open = 0xfffffff007e42390,
        .kernelcache__ptov_table = 0xfffffff0077abb90,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a1634b0,
        .kernelcache__vm_pages = 0xfffffff0077a89c8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0077aab50,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a1634a8,
        .kernelcache__vn_kqfilter = 0xfffffff007e94904,
    },
};
