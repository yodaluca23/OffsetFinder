...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a351980,
        .kernelcache__gPhysBase = 0xfffffff00785baa0,
        .kernelcache__gPhysSize = 0xfffffff00785baa0 + 8,
        .kernelcache__gVirtBase = 0xfffffff007859c88,
        .kernelcache__perfmon_devices = 0xfffffff00a38c0e0,
        .kernelcache__perfmon_dev_open = 0xfffffff007ec7ba0,
        .kernelcache__ptov_table = 0xfffffff00780fba8,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a38b4b0,
        .kernelcache__vm_pages = 0xfffffff00780c9d0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff00780eb58,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a38b4a8,
        .kernelcache__vn_kqfilter = 0xfffffff007f19ddc,
    },
};
