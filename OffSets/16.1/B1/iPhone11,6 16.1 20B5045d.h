...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.1.0: Sun Sep  4 20:45:07 PDT 2022; root:xnu-8792.40.93~10/RELEASE_ARM64_T8020",
        ...
        .kernelcache__cdevsw = 0xfffffff00a2a9980,
        .kernelcache__gPhysBase = 0xfffffff00781bb68,
        .kernelcache__gPhysSize = 0xfffffff00781bb68 + 8,
        .kernelcache__gVirtBase = 0xfffffff007819d50,
        .kernelcache__perfmon_devices = 0xfffffff00a2e40f0,
        .kernelcache__perfmon_dev_open = 0xfffffff007e86390,
        .kernelcache__ptov_table = 0xfffffff0077cfb90,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a2e34b0,
        .kernelcache__vm_pages = 0xfffffff0077cc9c8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0077ceb50,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a2e34a8,
        .kernelcache__vn_kqfilter = 0xfffffff007ed8904,
    },
};
