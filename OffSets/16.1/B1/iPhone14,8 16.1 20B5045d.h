...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a3a1998,
        ...
        .kernelcache__perfmon_devices = 0xfffffff00a3dc120,
        .kernelcache__perfmon_dev_open = 0xfffffff007ed7ff0,
        .kernelcache__ptov_table = 0xfffffff007803cb8,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a3db4b0,
        .kernelcache__vm_pages = 0xfffffff0078009e0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff007802c78,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a3db4a8,
        .kernelcache__vn_kqfilter = 0xfffffff007f27f18,
    },
};
