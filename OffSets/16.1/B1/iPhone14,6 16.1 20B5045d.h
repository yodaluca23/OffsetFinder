...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a41d998,
        .kernelcache__gPhysBase = 0xfffffff00785ffd0,
        .kernelcache__gPhysSize = 0xfffffff00785ffd0 + 8,
        .kernelcache__gVirtBase = 0xfffffff00785e1b8,
        .kernelcache__perfmon_devices = 0xfffffff00a458120,
        .kernelcache__perfmon_dev_open = 0xfffffff007ef3ff0,
        .kernelcache__ptov_table = 0xfffffff007813cb8,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a4574b0,
        .kernelcache__vm_pages = 0xfffffff0078109e0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff007812c78,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a4574a8,
        .kernelcache__vn_kqfilter = 0xfffffff007f43f18,
    },
};
