...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.1.0: Sun Sep  4 20:45:05 PDT 2022; root:xnu-8792.40.93~10/RELEASE_ARM64_T8030",
        ...
        .kernelcache__cdevsw = 0xfffffff00a39d980,
        .kernelcache__gPhysBase = 0xfffffff00786baa0,
        .kernelcache__gPhysSize = 0xfffffff00786baa0 + 8,
        .kernelcache__gVirtBase = 0xfffffff007869c88,
        .kernelcache__perfmon_devices = 0xfffffff00a3d80e0,
        .kernelcache__perfmon_dev_open = 0xfffffff007edfba0,
        .kernelcache__ptov_table = 0xfffffff00781fba8,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a3d74b0,
        .kernelcache__vm_pages = 0xfffffff00781c9d0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff00781eb58,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a3d74a8,
        .kernelcache__vn_kqfilter = 0xfffffff007f31ddc,
    },
};
