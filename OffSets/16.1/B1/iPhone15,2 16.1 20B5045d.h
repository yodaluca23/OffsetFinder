...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.1.0: Sun Sep  4 20:44:45 PDT 2022; root:xnu-8792.40.93~10/RELEASE_ARM64_T8120",
        ...
        .kernelcache__cdevsw = 0xfffffff00a36d998,
        .kernelcache__gPhysBase = 0xfffffff00784bee0,
        .kernelcache__gPhysSize = 0xfffffff00784bee0 + 8,
        .kernelcache__gVirtBase = 0xfffffff00784a0c8,
        .kernelcache__perfmon_devices = 0xfffffff00a3a8100,
        .kernelcache__perfmon_dev_open = 0xfffffff007ecfec4,
        .kernelcache__ptov_table = 0xfffffff0077ffd18,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a3a74b0,
        .kernelcache__vm_pages = 0xfffffff0077fc9d8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0077fecd8,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a3a74a8,
        .kernelcache__vn_kqfilter = 0xfffffff007f1fdec,
    },
};
